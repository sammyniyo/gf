<?php $__env->startSection('title', 'Privacy Policy | God\'s Family Choir'); ?>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 md:p-12 prose prose-lg max-w-none">
            ...
            <section class="mb-8">
                ...
                <p class="text-gray-700 leading-relaxed">
                    Welcome to God's Family Choir ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
                </p>
            </section>
            ...
            <section class="mb-8">
                ...
                <ul class="list-disc list-inside text-gray-700 space-y-2 mb-6">
                    <li>Register for choir membership</li>
                    <li>Register for events or concerts</li>
                    <li>Subscribe to our newsletter</li>
                    <li>Contact us through our website</li>
                    <li>Make contributions or donations</li>
                </ul>
                ...
                <ul class="list-disc list-inside text-gray-700 space-y-2 mb-6">
                    ...
                    <li>Address</li>
                    <li>Profile photo</li>
                    <li>Voice type and musical experience</li>
            ...
            <section class="mb-8">
                ...
                <ul class="list-disc list-inside text-gray-700 space-y-2">
                    ...
                    <li>Send event tickets and confirmations</li>
                    <li>Communicate important updates and announcements</li>
                    <li>Send newsletters and devotional content (with your consent)</li>
            ...
            <section class="mb-8">
                ...
                <ul class="list-disc list-inside text-gray-700 space-y-2">
                    ...
                    <li><strong>Service providers:</strong> With trusted third-party vendors who help us operate our website and services (e.g., email service providers, payment processors)</li>
                    <li><strong>Legal compliance:</strong> When required by law or to protect our rights</li>
                    <li><strong>Church community:</strong> Within our choir community for coordination purposes (e.g., member directory, event planning)</li>
                </ul>
            </section>
            ...
            <section class="mb-8">
                ...
                <ul class="list-disc list-inside text-gray-700 space-y-2">
                    ...
                    <li><strong>Withdraw consent:</strong> Withdraw consent for processing (e.g., newsletter subscription)</li>
                </ul>
            ...
            <section class="mb-8">
                ...
                <p class="text-gray-700 leading-relaxed">
                    Our services are not directed to individuals under the age of 13. We do not knowingly collect personal information from children. If you believe we have inadvertently collected information from a child, please contact us immediately so we can delete such information.
                </p>
            </section>
            ...
            <section class="mb-8">
                ...
                <p class="text-gray-700 leading-relaxed">
                    Our website may contain links to third-party websites (e.g., social media platforms, music streaming services). We are not responsible for the privacy practices of these external sites. We encourage you to read their privacy policies before providing any personal information.
                </p>
            </section>
            ...
            <section>
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Consent</h2>
                <p class="text-gray-700 leading-relaxed">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/privacy-policy.blade.php ENDPATH**/ ?>