...
<div class="group relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 overflow-hidden border border-gray-100">
    ...
    <a href="{{ route('shop.show', $album->id) }}" class="block relative aspect-square overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
        ...
        <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-end justify-center pb-8">
            <div class="flex gap-3 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                @if($album->spotify_url)
                <a href="{{ $album->spotify_url }}"
                   target="_blank"
                   class="bg-green-500 hover:bg-green-600 text-white p-3.5 rounded-full transition-all transform hover:scale-110 shadow-lg"
                ...
                <a href="{{ $album->apple_music_url }}"
                   target="_blank"
                   class="bg-pink-500 hover:bg-pink-600 text-white p-3.5 rounded-full transition-all transform hover:scale-110 shadow-lg"
                   onclick="event.stopPropagation()">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ $album->youtube_url }}"
                   target="_blank"
                   class="bg-red-500 hover:bg-red-600 text-white p-3.5 rounded-full transition-all transform hover:scale-110 shadow-lg"
                   onclick="event.stopPropagation()">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
