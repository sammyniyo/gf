<?php $__env->startSection('title', 'Devotions | God\'s Family Choir'); ?>
...
<section class="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-950 via-emerald-900 to-black">
    ...
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/gf-2.jpg')); ?>" alt="Daily Devotions" class="w-full h-full object-cover opacity-15" />
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php if($devotions->count() > 0): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                <?php $__currentLoopData = $devotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $devotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-2 animate-fade-in-up" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                        <!-- Image -->
                        <div class="relative h-48 overflow-hidden">
                            <?php if($devotion->featured_image): ?>
                                <img src="<?php echo e(Storage::url($devotion->featured_image)); ?>"
                            ...
                            <?php if($devotion->scripture_reference): ?>
                                <div class="mb-3">
                                    <span class="text-sm text-emerald-600 font-medium">
                                        📖 <?php echo e($devotion->scripture_reference); ?>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center text-sm text-gray-500">
                                    <?php if($devotion->author): ?>
                                        <span>By <?php echo e($devotion->author); ?></span>
                                    <?php endif; ?>
                                </div>

                                <a href="<?php echo e(route('devotions.show', $devotion)); ?>"
