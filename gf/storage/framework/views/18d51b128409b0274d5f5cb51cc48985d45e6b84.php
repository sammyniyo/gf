...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Back to Home -->
            <div class="text-center">
                <a href="<?php echo e(route('home')); ?>" class="text-sm text-gray-500 hover:text-gray-700 flex items-center justify-center">
            ...
            <div class="md:flex md:items-center md:justify-between">
                ...
                <div class="mt-4 md:mt-0">
                    <p class="text-center text-sm text-gray-400">
                        &copy; <?php echo e(date('Y')); ?> God's Family Choir | ASA UR Nyarugenge SDA. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/auth/login.blade.php ENDPATH**/ ?>