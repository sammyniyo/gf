<?php $__env->startSection('title', 'Leadership & Committee | God\'s Family Choir'); ?>
...
<section class="relative bg-white py-24">
    ...
    <div class="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        <?php if($committees->count() > 0): ?>
            <!-- Departments -->
            <div class="space-y-24">
                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($committees->has($department)): ?>
                        <div>
                            <!-- Department Header -->
                            <div class="mb-14 text-center">
                                <div class="inline-flex flex-col items-center gap-4">
                                    <div class="inline-flex items-center gap-3 rounded-2xl border-2 border-emerald-200 bg-white px-6 py-3 shadow-lg">
                                        ...
                                        <h2 class="text-2xl font-bold text-gray-900"><?php echo e($department); ?></h2>
                                        <span class="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 text-sm font-bold text-white shadow-md">
                                            <?php echo e($committees[$department]->count()); ?>
                            ...
                            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                <?php $__currentLoopData = $committees[$department]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="group relative">
                                        <div class="relative overflow-hidden rounded-2xl border-2 border-gray-200 bg-white shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 hover:border-emerald-300">
                                            ...
                                            <div class="relative h-80 overflow-hidden bg-gradient-to-br from-emerald-50 to-gray-100">
                                                ...
                                                <div class="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                                                    <div class="bg-white/95 backdrop-blur-sm rounded-xl px-3 py-2 shadow-lg">
                                                        <p class="text-xs font-bold text-emerald-600"><?php echo e($member->position); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-6">
                                                ...
                                                <!-- Social Links -->
                                                <?php if($member->formatted_social_links && count($member->formatted_social_links) > 0): ?>
                                                    <div class="mt-4 flex gap-2 border-t border-gray-100 pt-4">
                                                        <?php $__currentLoopData = $member->formatted_social_links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <a href="<?php echo e($social['url']); ?>"
                                                               ...
                                                               title="<?php echo e($social['platform']); ?>">
        ...
        <?php else: ?>
            ...
            <div class="mx-auto max-w-lg rounded-3xl border-2 border-emerald-200 bg-white p-12 text-center shadow-xl">
                ...
                <div class="mt-8">
                    <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-3 text-sm font-semibold text-white shadow-lg hover:shadow-xl transition-all hover:scale-105">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/committee/index.blade.php ENDPATH**/ ?>