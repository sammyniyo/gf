<?php $__env->startSection('title', 'Stories | God\'s Family Choir'); ?>
...
<section class="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-950 via-emerald-900 to-black">
    ...
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/gf-2.jpg')); ?>" alt="Our Story" class="w-full h-full object-cover opacity-15" />
                ...
                <?php $__currentLoopData = $stories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-2 animate-fade-in-up" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                        ...
                        <div class="relative h-48 overflow-hidden">
                            ...
                            <div class="absolute top-4 right-4">
                                <span class="px-3 py-1 bg-black/20 backdrop-blur-sm text-white text-sm font-medium rounded-full">
                                    <?php echo e($story->event_date ? $story->event_date->format('M Y') : $story->created_at->format('M Y')); ?>
                        ...
                        <div class="p-6">
                            ...
                            <a href="<?php echo e(route('story.show', $story)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/story/index.blade.php ENDPATH**/ ?>