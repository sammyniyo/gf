                        ...
                        <div class="relative">
                            ...
                            <div class="aspect-square bg-gradient-to-br from-emerald-100 to-amber-100 flex items-center justify-center overflow-hidden">
                                <?php if(isset($track['album']['images'][0]['url'])): ?>
                                    <img src="<?php echo e($track['album']['images'][0]['url']); ?>" alt="<?php echo e($track['name']); ?>" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">
                                <?php else: ?>
                                ...
                                <!-- Play Button -->
                                <a href="<?php echo e($track['external_urls']['spotify']); ?>" target="_blank" class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                            ...
                            <div class="p-4">
                                <h3 class="text-gray-900 font-bold text-base mb-1 line-clamp-2">
                                    <?php echo e($track['name']); ?>

                                </h3>
                                <p class="text-gray-500 text-xs line-clamp-1 mb-2">
                                    <?php echo e(collect($track['artists'])->pluck('name')->implode(', ')); ?>

                                </p>

                                <!-- Play Button -->
                                <a href="<?php echo e($track['external_urls']['spotify']); ?>" target="_blank"
                                ...
                                <div class="flex items-center justify-between mt-2 text-xs text-gray-400">
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($track['album']['release_date'])): ?>
                                        <span class="flex items-center gap-1 text-emerald-600 font-semibold">
                                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"/>
                                            </svg>
                                            <?php echo e(\Carbon\Carbon::parse($track['album']['release_date'])->format('M Y')); ?>
...
<?php /**PATH C:\Users\samsh\Documents\gf\resources\views/components/landing/spotify-dynamic.blade.php ENDPATH**/ ?>