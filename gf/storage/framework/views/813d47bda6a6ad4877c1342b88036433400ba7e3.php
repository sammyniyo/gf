...
<div class="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 overflow-hidden border border-gray-100 dark:border-gray-700">
    ...
    <!-- Album Cover -->
    <a href="<?php echo e(route('shop.show', $album->id)); ?>" class="block relative aspect-square overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800">
    ...
    <div class="p-6">
        ...
        <div class="flex items-center justify-between pt-6 mt-2 border-t-2 border-gray-200 dark:border-gray-700">
            <div>
                ...
                <?php else: ?>
                <div>
                    <span class="text-3xl font-extrabold text-gray-900 dark:text-white">$<?php echo e(number_format($album->price, 2)); ?></span>
