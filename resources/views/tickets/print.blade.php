...
<head>
    ...
    <title>Ticket - {{ $registration->registration_code }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
            ...
            <div class="ticket-grid">
                ...
                <div class="ticket-details">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-content">
                            ...
                            <div class="detail-value">{{ $registration->event->title }} ({{ ucfirst($registration->event->type) }})</div>
                        </div>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-content">
                            ...
                            <div class="detail-value">{{ $registration->event->start_at->format('l, F j, Y \a\t g:i A') }}</div>
                        </div>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-content">
                            ...
                            <div class="detail-value">{{ $registration->event->location ?? 'TBA' }}</div>
                        </div>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-content">
                            ...
                            <div class="detail-value">{{ $registration->registration_code }}</div>
                        </div>
                    </div>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-content">
                            ...
                            <div class="detail-value">{{ number_format($registration->total_amount) }} RWF</div>
                        </div>
                    </div>
                    @endif
                </div>
                ...
                <div class="qr-section">
                    ...
                    <div class="verification-info">
                        ...
                        {{ $registration->created_at->format('M j, Y g:i A') }}</p>
                    </div>
                </div>
            </div>
