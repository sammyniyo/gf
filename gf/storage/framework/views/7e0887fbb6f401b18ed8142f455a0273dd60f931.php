...
<section class="bg-gradient-to-b from-emerald-950 via-emerald-900 to-emerald-950 py-24 relative overflow-hidden" id="music">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="flex justify-center flex-wrap gap-3 mb-16">
            <?php $__currentLoopData = [
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button class="group px-6 py-3 rounded-full text-sm font-semibold transition-all bg-white/10 hover:bg-white/20 text-white border border-white/20 hover:border-white/40 backdrop-blur-sm flex items-center gap-2">
                    <?php if($platform['icon']): ?>
                        <img src="<?php echo e(asset('images/' . $platform['icon'])); ?>" class="h-5 w-5 opacity-80 group-hover:opacity-100" alt="<?php echo e($platform['name']); ?>">
                    <?php endif; ?>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 mb-16">
            <?php $__currentLoopData = [
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="group relative bg-emerald-800/40 backdrop-blur-sm p-5 rounded-2xl border border-emerald-700/50 hover:border-amber-500/50 transition-all duration-300 cursor-pointer transform hover:-translate-y-2 hover:shadow-2xl">
                    <div class="relative overflow-hidden rounded-xl aspect-square mb-4 bg-gradient-to-br from-emerald-600 to-emerald-800">
                        <img src="<?php echo e(asset('images/' . ($index % 5 + 1) . '.jpg')); ?>"
                            alt="<?php echo e($album['title']); ?> album cover"
                    ...
                    <h3 class="text-white font-bold truncate text-lg"><?php echo e($album['title']); ?></h3>
                    <p class="text-emerald-300 text-sm"><?php echo e($album['year']); ?></p>
        ...
        <div class="bg-gradient-to-r from-amber-900/40 to-emerald-900/40 backdrop-blur-sm border border-amber-500/30 text-white p-8 md:p-12 rounded-3xl flex flex-col lg:flex-row items-center gap-8 shadow-2xl">
            <div class="relative flex-shrink-0 w-full lg:w-1/3">
                <img src="<?php echo e(asset('images/gf-2.jpg')); ?>" alt="Featured performance" class="rounded-2xl w-full shadow-2xl">
            ...
            <div class="flex-1 space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $track): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-3 p-3 hover:bg-emerald-800/30 rounded-lg transition">
                            <span class="text-emerald-400 w-6 text-center"><?php echo e($loop->iteration); ?></span>
                            <div class="flex-1 min-w-0">
                                <p class="text-white font-medium truncate"><?php echo e($track['title']); ?></p>
                                <p class="text-emerald-300 text-xs truncate">God's Family Choir</p>
                            </div>
                            <span class="text-emerald-400 text-sm"><?php echo e($track['duration']); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="flex flex-wrap gap-4 pt-4">
                    ...
                    <a href="<?php echo e(route('events.index')); ?>" class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-full font-bold transition border border-white/30">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
<?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/components/landing/spotify-albums.blade.php ENDPATH**/ ?>