...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">Dear <?php echo e($fullName); ?>,</div>
            ...
            <div class="details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($fullName); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Email:</span>
                    <span class="detail-value"><?php echo e($member->email); ?></span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e(ucfirst($member->voice_type)); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Musical Experience:</span>
                    <span class="detail-value"><?php echo e(ucfirst($member->musical_experience)); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Application Date:</span>
                    <span class="detail-value"><?php echo e($member->created_at->format('F j, Y')); ?></span>
                </div>
            </div>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e(url('/')); ?>" class="cta-button">Visit Our Website</a>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <p style="font-size: 12px; color: #999; margin-top: 20px;">
                This email was sent to <?php echo e($member->email); ?> because you submitted a membership application to God's Family Choir.
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/mail/member-registration.blade.php ENDPATH**/ ?>