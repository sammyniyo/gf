...
<section class="relative bg-gradient-to-b from-white to-emerald-50/50 py-24 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div class="relative bg-white rounded-3xl shadow-2xl overflow-hidden transform group-hover:scale-[1.02] transition-all duration-500 ease-out">
                <div class="grid lg:grid-cols-2">
                    ...
                    <div class="relative h-64 lg:h-auto overflow-hidden">
                        <?php if($nextEvent->cover_image): ?>
                            <img src="<?php echo e(asset('storage/' . $nextEvent->cover_image)); ?>" alt="<?php echo e($nextEvent->title); ?>" class="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700 ease-out">
                        <?php else: ?>
                            <img src="<?php echo e(asset('images/gf-2.jpg')); ?>" alt="<?php echo e($nextEvent->title); ?>" class="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700 ease-out">
                        <?php endif; ?>
                        ...
                        <div class="absolute bottom-6 left-6">
                            <div class="px-4 py-2 bg-emerald-600 rounded-full shadow-lg backdrop-blur-xl">
                                <span class="text-white font-bold">🎵 <?php echo e(ucfirst($nextEvent->type)); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 lg:p-12 flex flex-col justify-center">
                        <div class="mb-8">
                            ...
                            <p class="text-gray-600 text-lg leading-relaxed mb-6">
                                <?php echo e($nextEvent->description ?? 'Join us for an inspiring Seventh-day Adventist worship experience filled with powerful praise, biblical testimonies, and heaven-touching harmonies.'); ?>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-6">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900 font-bold"><?php echo e($nextEvent->start_at->format('F d, Y')); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900 font-bold"><?php echo e($nextEvent->start_at->format('g:i A')); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-900 font-bold"><?php echo e($nextEvent->location); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                        ...
                        <div class="bg-gradient-to-br from-emerald-50 to-amber-50 rounded-2xl p-6 mb-6">
                            ...
                            <div id="countdown-<?php echo e($nextEvent->id); ?>" class="grid grid-cols-4 gap-3">
                                <div class="bg-white rounded-xl p-4 shadow-lg text-center transform hover:scale-105 transition-transform">
                                    <div class="text-3xl lg:text-4xl font-black text-emerald-600" data-days>00</div>
                                    <div class="text-xs text-gray-500 font-semibold mt-1">DAYS</div>
                                </div>
                                <div class="bg-white rounded-xl p-4 shadow-lg text-center transform hover:scale-105 transition-transform">
                                    <div class="text-3xl lg:text-4xl font-black text-amber-600" data-hours>00</div>
                                    <div class="text-xs text-gray-500 font-semibold mt-1">HOURS</div>
                                </div>
                                <div class="bg-white rounded-xl p-4 shadow-lg text-center transform hover:scale-105 transition-transform">
                                    <div class="text-3xl lg:text-4xl font-black text-blue-600" data-minutes>00</div>
                                    <div class="text-xs text-gray-500 font-semibold mt-1">MINS</div>
                                </div>
                                <div class="bg-white rounded-xl p-4 shadow-lg text-center transform hover:scale-105 transition-transform">
                                    <div class="text-3xl lg:text-4xl font-black text-purple-600" data-seconds>00</div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 md:gap-4">
                            ...
                            <button onclick="shareEvent<?php echo e($nextEvent->id); ?>()" class="group/share inline-flex items-center justify-center gap-2 px-5 md:px-6 py-3 md:py-4 bg-gray-100 text-gray-900 font-bold rounded-xl hover:bg-gray-200 hover:-translate-y-1 transition-all duration-500 text-sm md:text-base">
        ...
        <div class="text-center">
            <a href="<?php echo e(route('events.index')); ?>" class="inline-flex items-center gap-2 px-8 py-4 bg-white border-2 border-emerald-600 text-emerald-600 font-bold rounded-xl hover:bg-emerald-600 hover:text-white transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">
...
<script>
function shareEvent<?php echo e($nextEvent->id); ?>() {
    if (navigator.share) {
        navigator.share({
            title: '<?php echo e($nextEvent->title); ?> - God\'s Family Choir',
            text: 'Join us for an inspiring Seventh-day Adventist worship event!',
            url: '<?php echo e(route('events.show', $nextEvent)); ?>'
        }).then(() => {
            console.log('Thanks for sharing!');
        }).catch(console.error);
    } else {
        const url = '<?php echo e(route('events.show', $nextEvent)); ?>';
...
// Countdown Timer for Event ID <?php echo e($nextEvent->id); ?>

function initCountdown<?php echo e($nextEvent->id); ?>() {
    const countDownDate = new Date("<?php echo e($nextEvent->start_at->format('M d, Y H:i:s')); ?>").getTime();
    ...
    const x = setInterval(function() {
        ...
        const countdown = document.getElementById("countdown-<?php echo e($nextEvent->id); ?>");
        if (countdown) {
...
document.addEventListener('DOMContentLoaded', initCountdown<?php echo e($nextEvent->id); ?>);
</script>
<?php else: ?>
<!-- No Upcoming Event Message -->
<section class="relative bg-gradient-to-b from-white to-emerald-50/50 py-24">
    <div class="max-w-4xl mx-auto px-6 text-center">
        <div class="bg-white rounded-3xl shadow-xl p-12">
            ...
            <h3 class="text-3xl font-black text-gray-900 mb-4">More Events Coming Soon!</h3>
            <p class="text-gray-600 text-lg mb-6">
                We're preparing something special. Check back soon for our upcoming worship events.
            </p>
            <a href="<?php echo e(route('events.index')); ?>" class="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold rounded-xl hover:shadow-xl transition-all">
...
<?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/components/landing/upcoming-events-dynamic.blade.php ENDPATH**/ ?>