<?php $__env->startSection('page-title', 'Member Details'); ?>
    ...
    <div class="glass-card p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <?php endif; ?>
                <div>
                    <h1 class="text-2xl font-bold text-slate-900"><?php echo e($member->full_name); ?></h1>
                    <p class="text-lg text-slate-600"><?php echo e($member->occupation); ?></p>
                    <div class="flex items-center gap-2 mt-2">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold
                            <?php echo e($member->status === 'active' ? 'bg-emerald-100 text-emerald-700' : ''); ?>

                            <?php echo e($member->status === 'pending' ? 'bg-amber-100 text-amber-700' : ''); ?>

                            <?php echo e($member->status === 'inactive' ? 'bg-slate-100 text-slate-700' : ''); ?>">
                            <?php echo e(ucfirst($member->status)); ?>

                        </span>
                        <span class="text-sm text-slate-500">Member #<?php echo e(str_pad($member->id, 4, '0', STR_PAD_LEFT)); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <p class="text-sm text-slate-900"><?php echo e($member->email); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Phone</label>
                        <p class="text-sm text-slate-900"><?php echo e($member->phone); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Date of Birth</label>
                        <p class="text-sm text-slate-900"><?php echo e($member->date_of_birth?->format('F j, Y')); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Gender</label>
                        <p class="text-sm text-slate-900"><?php echo e(ucfirst($member->gender)); ?></p>
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-slate-500 mb-1">Address</label>
                        <p class="text-sm text-slate-900"><?php echo e($member->address); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <p class="text-sm text-slate-900"><?php echo e($member->occupation); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Workplace</label>
                        <p class="text-sm text-slate-900"><?php echo e($member->workplace ?? 'Not specified'); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Education Level</label>
                        <p class="text-sm text-slate-900"><?php echo e(ucfirst($member->education_level ?? 'Not specified')); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Skills</label>
                        <p class="text-sm text-slate-900"><?php echo e($member->skills ?? 'Not specified'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    ...
                    <div>
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                            <?php echo e($member->musical_experience === 'beginner' ? 'bg-emerald-100 text-emerald-700' : ''); ?>

                            <?php echo e($member->musical_experience === 'intermediate' ? 'bg-amber-100 text-amber-700' : ''); ?>

                            <?php echo e($member->musical_experience === 'advanced' ? 'bg-orange-100 text-orange-700' : ''); ?>

                            <?php echo e($member->musical_experience === 'professional' ? 'bg-red-100 text-red-700' : ''); ?>">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-900"><?php echo e($member->instruments ?? 'None specified'); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Choir Experience</label>
                        <p class="text-sm text-slate-900"><?php echo e(ucfirst($member->choir_experience ?? 'Not specified')); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Availability</label>
                        <p class="text-sm text-slate-900"><?php echo e(ucfirst($member->availability ?? 'Not specified')); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Newsletter</label>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                            <?php echo e($member->newsletter ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-700'); ?>">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-900 bg-slate-50 p-4 rounded-xl border border-slate-200"><?php echo e($member->why_join); ?></p>
                </div>
            </div>
            </div>
            ...
            <div class="glass-card p-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="text-sm text-slate-900"><?php echo e($member->emergency_contact_name); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Phone</label>
                        <p class="text-sm text-slate-900"><?php echo e($member->emergency_contact_phone); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card p-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="text-sm text-slate-900"><?php echo e($member->created_at->format('F j, Y \a\t g:i A')); ?></p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-500 mb-1">Member ID</label>
                        <p class="text-sm text-slate-900">#<?php echo e(str_pad($member->id, 4, '0', STR_PAD_LEFT)); ?></p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/admin/members/show.blade.php ENDPATH**/ ?>