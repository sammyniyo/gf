                            ...
                            <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($page == $paginator->currentPage()): ?>
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-gradient-to-r from-purple-500 to-pink-500 border border-transparent cursor-default leading-5"><?php echo e($page); ?></span>
                                    </span>
                                <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>