                ...
                <div class="text-gray-900 space-y-6">
                    ...
                    <div class="flex items-center gap-6 pt-4">
                        <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-black text-blue-600"><?php echo e($events->total()); ?></span>
                            <span class="text-sm text-gray-600 font-medium">Events</span>
                        </div>
                        <div class="w-px h-10 bg-gray-300"></div>
                        <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-black text-purple-600"><?php echo e($events->where('start_at', '>=', now())->count()); ?></span>
                            <span class="text-sm text-gray-600 font-medium">Upcoming</span>
                        </div>
                        <div class="w-px h-10 bg-gray-300"></div>
                        <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-black text-blue-600"><?php echo e($events->sum('capacity') ?? '∞'); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\resources\views/events/index.blade.php ENDPATH**/ ?>