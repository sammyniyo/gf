<?php $__env->startSection('title', $album->title . ' - Shop | God\'s Family Choir'); ?>
<?php $__env->startSection('description', $album->description ?? 'Purchase and download ' . $album->title . ' by God\'s Family Choir'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md mb-8">
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center text-gray-700 dark:text-gray-300">
                            ...
                            <span class="font-medium"><?php echo e($album->track_count); ?> Tracks</span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center text-gray-700 dark:text-gray-300">
                            ...
                            <span class="font-medium">Released <?php echo e($album->release_date->format('F Y')); ?></span>
                        </div>
                        <?php endif; ?>
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20 rounded-xl p-8 shadow-lg">
                    <div class="mb-6">
                        ...
                        <?php else: ?>
                        <div class="text-5xl font-bold text-gray-900 dark:text-white mb-2">$<?php echo e(number_format($album->price, 2)); ?></div>
                        <p class="text-gray-700 dark:text-gray-300">One-time purchase, unlimited downloads</p>
                        <?php endif; ?>
                    </div>

                    <a href="<?php echo e(route('shop.purchase', $album->id)); ?>"
                       class="block w-full bg-emerald-600 hover:bg-emerald-700 text-white text-center px-8 py-4 rounded-lg font-bold text-lg transition-all duration-200 transform hover:scale-[1.02] shadow-xl hover:shadow-2xl">
                        <?php echo e($album->isFree() ? 'Download Now' : 'Purchase & Download'); ?>
        ...
        <section class="border-t border-gray-200 dark:border-gray-700 pt-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <?php $__currentLoopData = $relatedAlbums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedAlbum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.shop.album-card','data' => ['album' => $relatedAlbum]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['album' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($relatedAlbum)]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/shop/show.blade.php ENDPATH**/ ?>