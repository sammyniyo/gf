...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear <?php echo e($attendee->name); ?>,</p>
            <p>You are invited to attend the following meeting:</p>

            <div class="details">
                <h2 style="margin-top: 0; color: #4f46e5;"><?php echo e($meeting->title); ?></h2>
                <?php if($meeting->description): ?>
                    <p><?php echo e($meeting->description); ?></p>
                <?php endif; ?>
                <p><strong>📅 Date & Time:</strong> <?php echo e($meeting->meeting_date->format('F d, Y \a\t h:i A')); ?></p>
                <?php if($meeting->location): ?>
                    <p><strong>📍 Location:</strong> <?php echo e($meeting->location); ?></p>
                <?php endif; ?>
                <?php if($meeting->meeting_link): ?>
                    <p><strong>🔗 Virtual Link:</strong> <a href="<?php echo e($meeting->meeting_link); ?>">Join Meeting</a></p>
                <?php endif; ?>
            </div>

            <?php if($meeting->meeting_link): ?>
                <p style="text-align: center; margin: 30px 0;">
                    <a href="<?php echo e($meeting->meeting_link); ?>" class="button">Join Virtual Meeting</a>
                </p>
            <?php endif; ?>
...
<?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/mail/meeting-invitation.blade.php ENDPATH**/ ?>