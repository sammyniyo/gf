...
<section class="relative bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-950 text-white py-32 overflow-hidden">
    ...
    <div class="max-w-5xl mx-auto px-6 text-center relative z-10">
        ...
        <div class="flex flex-wrap items-center justify-center gap-8 mb-12">
            <a href="{{ route('about') }}" class="group flex items-center gap-2 text-emerald-200 hover:text-white transition-colors">
            ...
            <a href="{{ route('contact') }}" class="group flex items-center gap-2 text-emerald-200 hover:text-white transition-colors">
            ...
            <a href="{{ route('story') }}" class="group flex items-center gap-2 text-emerald-200 hover:text-white transition-colors">
