...
<div class="space-y-6">
    ...
    <section class="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
        ...
        <article class="relative overflow-hidden rounded-2xl border border-emerald-100 bg-white/85 p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
            ...
            <p class="mt-6 text-3xl font-semibold text-slate-900"><?php echo e($total_registrations); ?></p>
            <p class="mt-2 text-sm text-slate-500">Across <?php echo e($total_events); ?> curated events</p>
            <a href="<?php echo e(route('admin.registrations.index')); ?>" class="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-emerald-600">
                View attendee list
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
        ...
        <article class="relative overflow-hidden rounded-2xl border border-rose-100 bg-white/85 p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
            ...
            <p class="mt-6 text-3xl font-semibold text-slate-900"><?php echo e($total_contacts); ?></p>
            <p class="mt-2 text-sm text-slate-500">Community touchpoints captured</p>
            <a href="<?php echo e(route('admin.contacts.index')); ?>" class="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-rose-600">
                Open inbox
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
