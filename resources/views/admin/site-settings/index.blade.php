...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <form action="{{ route('admin.site-settings.update') }}" method="POST" class="glass-card p-8 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex items-center justify-between p-6 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg border-2 border-emerald-200">
            ...
            <label class="relative inline-flex items-center cursor-pointer">
                ...
                <input type="checkbox" name="is_coming_soon" id="is_coming_soon" value="1" class="sr-only peer" {{ $settings->is_coming_soon ? 'checked' : '' }}>
        ...
        <div>
            ...
            <input
                ...
                value="{{ old('coming_soon_title', $settings->coming_soon_title) }}"
        ...
        <div>
            ...
            >{{ old('coming_soon_message', $settings->coming_soon_message) }}</textarea>
        </div>
        ...
        <div>
            ...
            <input
                ...
                name="target_date"
                id="target_date"
                value="{{ old('target_date', $settings->target_date ? $settings->target_date->format('Y-m-d') : '') }}"
                class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
            >
        ...
        <div class="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div class="flex items-center gap-2 text-blue-800">
                ...
                <span class="font-semibold">Coming Soon Mode is {{ $settings->is_coming_soon ? 'ACTIVE' : 'INACTIVE' }}</span>
            </div>
