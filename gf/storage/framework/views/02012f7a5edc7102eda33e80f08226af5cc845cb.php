        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-12 border-b border-gray-800">
            ...
            <div class="lg:col-span-4">
                <!-- <div class="flex items-center mb-6">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="God's Family Choir" class="h-16 w-auto">
                </div> -->
            ...
            <div class="lg:col-span-2">
                ...
                <ul class="space-y-3">
                    <?php $__currentLoopData = [
                        ...
                        <li>
                            <a href="<?php echo e($link['url']); ?>" class="group inline-flex items-center gap-2 text-gray-400 hover:text-emerald-400 transition-colors">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="text-center md:text-left">
                    <p class="text-gray-500 text-sm">
                        © <?php echo e(date('Y')); ?> <span class="text-emerald-400 font-semibold">God's Family Choir</span> - ASA UR Nyarugenge SDA
                    </p>
                ...
                <div class="flex items-center gap-6">
                    <?php $__currentLoopData = ['Privacy Policy', 'Terms of Service', 'Contact']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
