...
<body>
    ...
    <script>
        ...
        const targetDate = <?php echo json_encode($settings->target_date ? \Carbon\Carbon::parse($settings->target_date)->format('Y-m-d H:i:s') : null, 15, 512) ?>;
...
<?php /**PATH C:\Users\samsh\Documents\gf\resources\views/pages/site-coming-soon.blade.php ENDPATH**/ ?>