...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1">{{ \App\Models\Album::count() }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1">{{ \App\Models\Album::where('is_active', true)->count() }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1">{{ \App\Models\Album::where('is_featured', true)->count() }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">With ZIP Files</p>
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1">{{ \App\Models\Album::whereNotNull('download_link')->count() }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1">${{ number_format(\App\Models\AlbumPurchase::completed()->sum('amount'), 2) }}</p>
                </div>
