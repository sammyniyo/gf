    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <nav class="hidden md:flex items-center space-x-1">
                ...
                <a href="<?php echo e(route('resources.index')); ?>" class="px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 flex items-center hover:bg-emerald-700/50 hover:text-amber-100 <?php echo e(request()->is('utility-folder*') || request()->is('resources*') ? 'bg-emerald-700/50 text-amber-100' : ''); ?>">
    ...
    <div x-show="mobileMenuOpen"
        ...
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="/about" @click="mobileMenuOpen = false"
                class="flex items-center px-3 py-3 rounded-md text-base font-medium text-white hover:bg-emerald-700 transition-all duration-200 <?php echo e(request()->is('about*') ? 'bg-emerald-700 text-amber-100' : ''); ?>">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                About
            ...
            <a href="<?php echo e(route('story')); ?>" @click="mobileMenuOpen = false"
                class="flex items-center px-3 py-3 rounded-md text-base font-medium text-white hover:bg-emerald-700 transition-all duration-200 <?php echo e(request()->is('story*') ? 'bg-emerald-700 text-amber-100' : ''); ?>">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                Stories
            ...
            <a href="/events" @click="mobileMenuOpen = false"
                class="flex items-center px-3 py-3 rounded-md text-base font-medium text-white hover:bg-emerald-700 transition-all duration-200 <?php echo e(request()->is('events*') ? 'bg-emerald-700 text-amber-100' : ''); ?>">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                Events
            ...
            <a href="<?php echo e(route('devotions.index')); ?>" @click="mobileMenuOpen = false"
                class="flex items-center px-3 py-3 rounded-md text-base font-medium text-white hover:bg-emerald-700 transition-all duration-200 <?php echo e(request()->is('devotions*') ? 'bg-emerald-700 text-amber-100' : ''); ?>">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                Devotions
            ...
            <a href="<?php echo e(route('committee.index')); ?>" @click="mobileMenuOpen = false"
                class="flex items-center px-3 py-3 rounded-md text-base font-medium text-white hover:bg-emerald-700 transition-all duration-200 <?php echo e(request()->is('committee*') ? 'bg-emerald-700 text-amber-100' : ''); ?>">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                Committee
            ...
            <a href="<?php echo e(route('resources.index')); ?>" @click="mobileMenuOpen = false"
                class="flex items-center px-3 py-3 rounded-md text-base font-medium text-white hover:bg-emerald-700 transition-all duration-200 <?php echo e(request()->is('utility-folder*') || request()->is('resources*') ? 'bg-emerald-700 text-amber-100' : ''); ?>">
