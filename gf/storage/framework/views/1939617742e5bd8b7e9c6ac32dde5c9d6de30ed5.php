...
<section class="relative bg-white py-24 overflow-hidden">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="gallery">
            <?php $__currentLoopData = [
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="group relative cursor-pointer overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2"
                    ...
                    <!-- Image -->
                    <img src="<?php echo e(asset('images/' . $photo['image'])); ?>"
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div class="absolute bottom-0 left-0 right-0 p-6">
                            ...
                            <h3 class="text-white font-bold text-xl mb-2"><?php echo e($photo['title']); ?></h3>
...
<?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/components/landing/interactive-gallery.blade.php ENDPATH**/ ?>