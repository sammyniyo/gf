<?php $__env->startSection('title', $story->meta_title ?? $story->title . ' | God\'s Family Choir'); ?>
<?php $__env->startSection('meta_description', $story->meta_description ?? $story->excerpt); ?>
<?php $__env->startSection('meta_keywords', $story->meta_keywords ? implode(', ', $story->meta_keywords) : ''); ?>
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <nav class="mb-8">
                <ol class="flex flex-wrap items-center gap-2 text-sm text-gray-600">
                    ...
                    <li>
                        <a href="<?php echo e(route('stories.index')); ?>" class="transition-colors hover:text-emerald-600">Stories</a>
                    </li>
                    <li>
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    ...
                    <li class="max-w-xs truncate font-medium text-amber-600"><?php echo e($story->title); ?></li>
                </ol>
            </nav>
            ...
            <div class="flex flex-wrap items-center gap-4">
                <?php if($story->author): ?>
                    <div class="flex items-center gap-3 rounded-xl border-2 border-gray-200 bg-white px-4 py-3 shadow-sm">
                        <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 text-lg font-bold text-white shadow-md">
                            <?php echo e(strtoupper(substr($story->author->name, 0, 1))); ?>

                        </div>
                        <div>
                            <div class="text-xs text-gray-500">Written by</div>
                            <div class="font-bold text-gray-900"><?php echo e($story->author->name); ?></div>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="flex items-center gap-2 rounded-xl border-2 border-gray-200 bg-white px-4 py-3 shadow-sm">
                    ...
                    <span class="font-semibold text-gray-700"><?php echo e($story->published_at->format('M d, Y')); ?></span>
                </div>
                <div class="flex items-center gap-2 rounded-xl border-2 border-gray-200 bg-white px-4 py-3 shadow-sm">
                    <svg class="h-5 w-5 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span class="font-semibold text-gray-700"><?php echo e($story->reading_time); ?> min read</span>
                </div>
                <div class="flex items-center gap-2 rounded-xl border-2 border-gray-200 bg-white px-4 py-3 shadow-sm">
                    ...
                    <span class="font-semibold text-gray-700"><?php echo e(number_format($story->views_count)); ?> views</span>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <?php if($story->featured_image): ?>
                <div class="mb-12 overflow-hidden rounded-3xl shadow-2xl border-4 border-white">
                    <img src="<?php echo e(asset('storage/' . $story->featured_image)); ?>" alt="<?php echo e($story->title); ?>" class="w-full h-auto">
                </div>
            <?php endif; ?>
                ...
                <div class="mb-8 overflow-hidden rounded-2xl border-2 border-gray-100 bg-gradient-to-r from-gray-50 to-gray-100 p-6 shadow-lg">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = $story->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('stories.index', ['tag' => $tag])); ?>" class="inline-flex items-center gap-1.5 rounded-full border-2 border-white bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm transition-all hover:border-emerald-400 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-emerald-700 hover:text-white hover:shadow-md hover:scale-105">
                    ...
                    <div class="space-y-3">
                        ...
                        <button onclick="likeStory()" id="like-btn" class="group flex w-full items-center gap-4 rounded-2xl bg-gradient-to-r from-red-500 to-pink-600 px-8 py-4 font-bold text-white shadow-xl transition-all hover:shadow-2xl hover:from-red-600 hover:to-pink-700 hover:scale-105">
                            ...
                            <div class="text-left">
                                ...
                                <div class="text-lg font-black" id="like-count"><?php echo e(number_format($story->likes_count)); ?> Likes</div>
                            </div>
                        </button>
                    </div>
            ...
            <?php if($story->author): ?>
                <div class="mb-12 overflow-hidden rounded-3xl border-2 border-gray-100 bg-gradient-to-r from-emerald-50 via-amber-50 to-emerald-50 shadow-xl">
                    ...
                    <div class="flex items-start gap-6 p-8">
                        ...
                        <div class="flex-1">
                            <h4 class="text-2xl font-bold text-gray-900 mb-2"><?php echo e($story->author->name); ?></h4>
                ...
                <div class="grid gap-8 md:grid-cols-3">
                    <?php $__currentLoopData = $relatedStories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="group overflow-hidden rounded-2xl border-2 border-gray-100 bg-white shadow-lg transition-all hover:shadow-2xl hover:-translate-y-2">
                            <a href="<?php echo e(route('story.show', $related)); ?>" class="block">
                                <?php if($related->featured_image): ?>
                                    <div class="relative h-52 overflow-hidden">
                                        <img src="<?php echo e(asset('storage/' . $related->featured_image)); ?>" alt="<?php echo e($related->title); ?>" class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110">
                            ...
                            <div class="p-6 space-y-4">
                                <h3 class="text-xl font-bold text-gray-900 line-clamp-2 group-hover:text-emerald-600 transition-colors">
                                    <a href="<?php echo e(route('story.show', $related)); ?>"><?php echo e($related->title); ?></a>
                                </h3>
                                <p class="text-gray-600 line-clamp-2"><?php echo e(Str::limit($related->excerpt, 100)); ?></p>
                                <div class="flex items-center justify-between border-t-2 border-gray-100 pt-4 text-sm text-gray-500">
                                    <span class="flex items-center gap-1.5">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <?php echo e($related->reading_time); ?> min
                                    </span>
                                    <span class="flex items-center gap-1.5">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
        ...
        <div class="mx-auto max-w-5xl">
            <div class="relative overflow-hidden rounded-3xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-600 via-emerald-500 to-blue-600 p-12 text-center shadow-2xl">
                ...
                <div class="relative">
                    ...
                    <a href="<?php echo e(route('stories.index')); ?>" class="inline-flex items-center gap-3 rounded-xl bg-white px-8 py-4 font-bold text-emerald-700 shadow-xl transition-all hover:shadow-2xl hover:bg-gray-50 hover:-translate-y-1">
...
function likeStory() {
    ...
    fetch('<?php echo e(route("story.like", $story)); ?>', {
        method: 'POST',
        headers: {
...
function shareOnSocial(platform) {
    ...
    const title = encodeURIComponent('<?php echo e($story->title); ?>');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/stories/show.blade.php ENDPATH**/ ?>