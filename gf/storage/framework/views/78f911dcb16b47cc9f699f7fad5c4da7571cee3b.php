<?php $__env->startSection('page-title', 'Add Contribution'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-semibold text-slate-900">Add New Contribution</h1>
            <p class="mt-1 text-sm text-slate-500">Record a new member contribution</p>
        </div>
    ...
    <div class="glass-card p-6">
        <form action="<?php echo e(route('admin.contributions.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $targets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $target): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($target->id); ?>" <?php echo e(old('target_id') == $target->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="month" name="month" id="month" value="<?php echo e(old('month', now()->format('Y-m'))); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="amount" id="amount" value="<?php echo e(old('amount')); ?>" min="0" step="0.01" required
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="one_time" <?php echo e(old('payment_type') === 'one_time' ? 'selected' : ''); ?>>One-time</option>
                        </select>
                    ...
                    <div class="flex items-end pb-2">
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="has_paid" value="1" <?php echo e(old('has_paid') ? 'checked' : ''); ?>

                                       class="rounded border-slate-300 text-emerald-600 focus:ring-emerald-500">
                                <span class="ml-2 text-sm font-medium text-slate-700">Mark as Paid</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="is_recurring" value="1" <?php echo e(old('is_recurring') ? 'checked' : ''); ?>
...
function memberSearch() {
    return {
        ...
        init() {
            ...
            // Set selected member if old value exists
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/admin/contributions/create.blade.php ENDPATH**/ ?>