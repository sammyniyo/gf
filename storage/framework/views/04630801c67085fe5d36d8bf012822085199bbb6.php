...
<!-- Beautiful Hero Section with Light Colors -->
<section class="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 text-gray-800 py-24 overflow-hidden">
    <!-- Soft Animated Background Patterns -->
    ...
    <div class="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <!-- Badge -->
        <div class="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-blue-200 rounded-full px-4 py-2 mb-6 animate-fade-in shadow-lg">
            <svg class="w-5 h-5 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9 2a2 2 0 00-2 2v8a2 2 0 002 2h6a2 2 0 002-2V6.414A2 2 0 0016.414 5L14 2.586A2 2 0 0012.586 2H9z" />
            </svg>
            <span class="text-sm font-semibold text-blue-700">Premium Digital Albums</span>
        </div>

        <h1 class="text-5xl md:text-7xl font-extrabold mb-6 animate-fade-in bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">
            Divine Music Store
        </h1>
        <p class="text-xl md:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto animate-fade-in animation-delay-200">
        ...
        <form action="<?php echo e(route('shop.search')); ?>" method="GET" class="max-w-2xl mx-auto mb-8 animate-fade-in animation-delay-400">
            <div class="relative group">
                <div class="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full blur-lg opacity-30 group-hover:opacity-50 transition-opacity"></div>
                <div class="relative bg-white rounded-full shadow-2xl border border-gray-200">
                    <input type="text"
                           name="q"
                    ...
                    <button type="submit"
                            class="absolute right-2 top-1/2 -translate-y-1/2 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg">
        ...
        <div class="flex flex-wrap justify-center gap-8 text-center animate-fade-in animation-delay-600">
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-4 border border-blue-200 shadow-lg">
                <div class="text-3xl font-bold text-blue-600"><?php echo e(\App\Models\Album::active()->count()); ?>+</div>
                <div class="text-sm text-blue-500">Albums Available</div>
            </div>
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-4 border border-purple-200 shadow-lg">
                <div class="text-3xl font-bold text-purple-600">🎵</div>
                <div class="text-sm text-purple-500">High Quality Audio</div>
            </div>
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-4 border border-indigo-200 shadow-lg">
                <div class="text-3xl font-bold text-indigo-600">∞</div>
                <div class="text-sm text-indigo-500">Unlimited Streaming</div>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20 bg-gradient-to-b from-white to-blue-50 relative overflow-hidden">
    ...
    <div class="absolute top-0 right-0 w-72 h-72 bg-blue-100 rounded-full filter blur-3xl opacity-40 -mr-36 -mt-36"></div>
    <div class="absolute bottom-0 left-0 w-96 h-96 bg-purple-100 rounded-full filter blur-3xl opacity-40 -ml-48 -mb-48"></div>

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="text-center mb-12">
            <div class="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-400 to-orange-400 text-white rounded-full px-4 py-2 mb-4 shadow-lg">
...
<!-- All Albums -->
<section class="py-20 bg-gradient-to-b from-blue-50 to-white relative">
    ...
    <div class="absolute top-8 left-8 w-20 h-20 border-l-2 border-t-2 border-blue-300/30 rounded-tl-3xl"></div>
    <div class="absolute top-8 right-8 w-20 h-20 border-r-2 border-t-2 border-purple-300/30 rounded-tr-3xl"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
            ...
            <div class="mt-4 md:mt-0">
                <div class="inline-flex items-center gap-3 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full px-6 py-3 border-2 border-blue-200">
                    <svg class="w-5 h-5 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9 2a2 2 0 00-2 2v8a2 2 0 002 2h6a2 2 0 002-2V6.414A2 2 0 0016.414 5L14 2.586A2 2 0 0012.586 2H9z" />
                    </svg>
                    <span class="font-bold text-2xl text-blue-600"><?php echo e($albums->total()); ?></span>
                    <span class="text-gray-600 font-medium"><?php echo e(Str::plural('Album', $albums->total())); ?></span>
                </div>
            </div>
        </div>
            ...
            <div class="mb-8" x-data="{ activeFilter: 'all', showFilters: false }">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <button @click="showFilters = !showFilters"
                            class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg font-semibold hover:from-blue-600 hover:to-purple-600 transition-all shadow-md hover:shadow-lg transform hover:scale-105 cursor-pointer">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-show="showFilters"
                    ...
                    <div class="flex flex-wrap gap-3">
                        <button @click="activeFilter = 'all'"
                                :class="activeFilter === 'all' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700'"
                                class="px-4 py-2 rounded-lg font-semibold hover:bg-blue-500 hover:text-white transition-all shadow-md cursor-pointer">
                            All Genres
                        </button>
                        <button @click="activeFilter = 'newest'"
                                :class="activeFilter === 'newest' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700'"
                                class="px-4 py-2 rounded-lg font-semibold hover:bg-blue-500 hover:text-white transition-all shadow-md cursor-pointer">
                            Newest First
                        </button>
                        <button @click="activeFilter = 'price'"
                                :class="activeFilter === 'price' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700'"
                                class="px-4 py-2 rounded-lg font-semibold hover:bg-blue-500 hover:text-white transition-all shadow-md cursor-pointer">
                            Price: Low to High
                        </button>
                        <button @click="activeFilter = 'popular'"
                                :class="activeFilter === 'popular' ? 'bg-blue-500 text-white' : 'bg-white text-gray-700'"
                                class="px-4 py-2 rounded-lg font-semibold hover:bg-blue-500 hover:text-white transition-all shadow-md cursor-pointer">
                            Most Popular
                        </button>
                    </div>
...
<?php endif; ?>
        ...
        <?php else: ?>
            <div class="text-center py-20">
                ...
                <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold transition-all transform hover:scale-105 shadow-lg">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Support CTA -->
<section class="relative py-24 bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 text-white overflow-hidden">
    ...
    <div class="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-10"></div>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <div class="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                ...
                <div class="text-blue-100 text-sm">Goes to Ministry</div>
            </div>
            <div class="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                <div class="text-4xl font-bold text-white mb-2">🎵</div>
                <div class="text-blue-100 text-sm">Quality Worship</div>
            </div>
            <div class="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30">
                <div class="text-4xl font-bold text-white mb-2">✨</div>
                <div class="text-blue-100 text-sm">Lives Changed</div>
            </div>
        </div>

        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="<?php echo e(route('contact')); ?>"
               class="group inline-flex items-center gap-2 bg-white text-blue-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-blue-50 transition-all transform hover:scale-105 shadow-2xl">
        ...
        <div class="mt-10 pt-8 border-t border-white/30">
            <p class="text-sm text-blue-100 mb-4">Trusted by thousands of worshipers worldwide</p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Documents/gf-1/resources/views/shop/index.blade.php ENDPATH**/ ?>