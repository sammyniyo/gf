    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        <div class="inline-block mb-6 animate-fade-in-up">
            <span class="px-4 py-2 bg-amber-500/20 backdrop-blur-xl border border-amber-400/30 rounded-full text-amber-300 text-sm font-semibold">
                <?php echo e(strtoupper($event->type)); ?>
        ...
        <div class="flex justify-center gap-8 mb-8 animate-fade-in-up animation-delay-600">
            <div class="text-center">
                ...
                <p class="text-emerald-200 font-bold text-lg"><?php echo e($event->start_at->format('M j, Y')); ?></p>
                <p class="text-emerald-300 text-sm"><?php echo e($event->start_at->format('g:i A')); ?></p>
            </div>
            ...
            <?php if($event->location): ?>
                <div class="text-center">
                    ...
                    <p class="text-emerald-200 font-bold text-lg"><?php echo e($event->location); ?></p>
            ...
            <?php if($event->capacity): ?>
                <div class="text-center">
                    ...
                    <p class="text-emerald-200 font-bold text-lg"><?php echo e($event->capacity); ?></p>
                    ...
                    <div class="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-8 border border-emerald-100">
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <span class="text-sm font-semibold text-gray-700">
                                <?php echo e($event->registrations_count); ?> / <?php echo e($event->capacity); ?>
                        ...
                        <p class="text-gray-600">
                            ...
                            <?php else: ?>
                                <?php echo e($event->capacity - $event->registrations_count); ?> spots remaining.
                            <?php endif; ?>
                        </p>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <?php if($event->end_at): ?>
                                    <p class="text-gray-600">Until <?php echo e($event->end_at->format('g:i A')); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
