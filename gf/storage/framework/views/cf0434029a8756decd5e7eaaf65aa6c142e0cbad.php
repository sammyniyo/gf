...
<section class="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-950 via-emerald-900 to-black">
    ...
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/gf-2.jpg')); ?>" alt="Events" class="w-full h-full object-cover opacity-15" />
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <?php for($i = 1; $i <= 8; $i++): ?>
            <div class="absolute musical-note" style="
                ...
                animation-delay: <?php echo e($i * 0.6); ?>s;
                font-size: <?php echo e(rand(25, 55)); ?>px;
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <div class="flex justify-center gap-8 mb-8 animate-fade-in-up animation-delay-600">
            <div class="text-center">
                <p class="text-3xl font-black text-amber-400"><?php echo e($events->total()); ?></p>
                <p class="text-sm text-emerald-300">Events Listed</p>
            </div>
            <div class="w-px bg-emerald-700"></div>
            <div class="text-center">
                <p class="text-3xl font-black text-amber-400"><?php echo e($events->where('start_at', '>=', now())->count()); ?></p>
        ...
        <form method="GET" action="<?php echo e(route('events.index')); ?>" class="space-y-4" id="filterForm">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="flex gap-2">
                    <?php $__currentLoopData = ['upcoming' => 'Upcoming', 'past' => 'Past', 'all' => 'All']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(request()->has(['q', 'type', 'from', 'to', 'open_only']) && request()->filled(['q', 'type', 'from', 'to']) || request()->boolean('open_only')): ?>
                    <a href="<?php echo e(route('events.index')); ?>" class="inline-flex items-center gap-1 px-3 py-2 rounded-full text-gray-500 text-sm font-medium hover:bg-gray-100 transition-all">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="max-w-7xl mx-auto px-6">
        <?php if($events->isEmpty()): ?>
            ...
            <div class="text-center py-20">
                ...
                <a href="<?php echo e(route('events.index')); ?>" class="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold rounded-xl hover:shadow-xl transition-all">
                    ...
                    <article class="group relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                        ...
                        <div class="relative h-56 overflow-hidden">
                            <?php if($event->cover_image): ?>
                                <img src="<?php echo e(Storage::url($event->cover_image)); ?>" alt="<?php echo e($event->title); ?>" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700" />
                            <?php else: ?>
                            ...
                            <div class="absolute top-4 right-4">
                                <span class="px-4 py-2 rounded-full text-xs font-bold backdrop-blur-xl border
                                    <?php echo e($isPast ? 'bg-gray-500/80 border-gray-400/50 text-white' :
                                       ($isFull ? 'bg-red-500/80 border-red-400/50 text-white' :
                                       'bg-emerald-500/80 border-emerald-400/50 text-white')); ?>">
                                    <?php echo e($isPast ? '📅 Past Event' : ($isFull ? '🔒 Full' : '✅ Open')); ?>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex items-start gap-4 text-sm text-gray-600">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span><?php echo e($event->start_at->format('M j, Y')); ?></span>
                                </div>
                            ...
                            <div class="flex items-center gap-2 pt-2">
                                <?php if($seatsLeft !== null): ?>
                                    ...
                                    <span class="text-sm font-semibold <?php echo e($seatsLeft > 0 ? 'text-emerald-600' : 'text-red-600'); ?>">
                                        <?php echo e($seatsLeft); ?> <?php echo e(Str::plural('seat', $seatsLeft)); ?> left
                                    </span>
                                <?php else: ?>
                            ...
                            <div class="flex gap-3 pt-4">
                                <a href="<?php echo e(route('events.show', $event)); ?>"
                                    ...
                                    <?php if($isOpen): ?>
                                        ...
                                        Register Now
                                    <?php else: ?>
                                        <?php echo e($isPast ? '📅 Past Event' : '🔒 Full'); ?>
