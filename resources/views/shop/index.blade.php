...
<section class="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 text-gray-800 py-24 overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <!-- Enhanced Search Bar -->
        <form action="{{ route('shop.search') }}" method="GET" class="max-w-2xl mx-auto mb-8 animate-fade-in animation-delay-400">
        ...
        <div class="flex flex-wrap justify-center gap-8 text-center animate-fade-in animation-delay-600">
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-4 border border-blue-200 shadow-lg">
                <div class="text-3xl font-bold text-blue-600">{{ \App\Models\Album::active()->count() }}+</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
            ...
            <div class="mt-4 md:mt-0">
                <div class="inline-flex items-center gap-3 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full px-6 py-3 border-2 border-blue-200">
                    ...
                    <span class="font-bold text-2xl text-blue-600">{{ $albums->total() }}</span>
        ...
        @else
            <div class="text-center py-20">
                ...
                <a href="{{ route('home') }}" class="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold transition-all transform hover:scale-105 shadow-lg">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
