...
<div class="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white">
        ...
        <div class="mx-auto max-w-6xl">
            <div class="flex flex-col gap-10 lg:gap-12 lg:flex-row lg:items-center">
                <div class="flex-1 space-y-6">
                    ...
                    <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 leading-tight">
                        One family, one sound, one <span class="text-emerald-700">mission</span>
                    </h1>
                    ...
                    <div class="pt-4">
                        <a href="#journey" class="inline-flex items-center gap-2 rounded-full bg-emerald-700 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-emerald-600">
                            Explore our journey
    ...
    <!-- Stats -->
    <section class="relative z-10 px-4 py-16 sm:px-8 lg:px-12">
        <div class="mx-auto max-w-6xl">
               <div class="grid gap-5 rounded-3xl border border-emerald-100 bg-white p-6 sm:p-8 shadow-xl sm:grid-cols-2 lg:grid-cols-4">
                @php
                    $stats = [
