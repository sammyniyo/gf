...
<div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <a href="{{ route('admin.registrations.index') }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-600 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 shadow-sm hover:shadow-md">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="flex items-start gap-4 p-4 bg-slate-50 rounded-xl">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-1 flex items-center gap-3">
                                <p class="text-lg font-mono font-semibold text-slate-900">{{ $registration->registration_code }}</p>
                                <button onclick="copyToClipboard('{{ $registration->registration_code }}')" class="p-1 text-slate-400 hover:text-slate-600 transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-lg font-semibold text-slate-900">{{ $registration->name }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-lg font-semibold text-slate-900">{{ $registration->email }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-lg font-semibold text-slate-900">{{ $registration->phone ?? 'Not provided' }}</p>
                            </div>
                        </div>
                    ...
                    @if($registration->total_amount)
                        <div class="flex items-start gap-3 p-4 bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-xl border border-emerald-200">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-2xl font-bold text-emerald-800">{{ number_format($registration->total_amount) }} RWF</p>
                    ...
                    <div class="flex items-start gap-3 p-4 bg-slate-50 rounded-xl">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-1 text-lg font-semibold text-slate-900">{{ $registration->created_at->format('F d, Y') }}</p>
                            <p class="text-sm text-slate-500">{{ $registration->created_at->format('h:i A') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    @if($registration->event)
                        ...
                        @if($registration->event->cover_image)
                            <div class="mb-6">
                                <img src="{{ Storage::url($registration->event->cover_image) }}" alt="{{ $registration->event->title }}" class="w-full h-48 object-cover rounded-xl shadow-lg">
                            </div>
                        @endif
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-xl font-bold text-slate-900">{{ $registration->event->title }}</p>
                            ...
                            @if($registration->event->description)
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-slate-900">{{ $registration->event->description }}</p>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-start gap-3 p-4 bg-slate-50 rounded-xl">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-lg font-semibold text-slate-900">{{ $registration->event->start_at->format('M d, Y') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3 p-4 bg-slate-50 rounded-xl">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-lg font-semibold text-slate-900">{{ $registration->event->start_at->format('h:i A') }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 p-4 bg-slate-50 rounded-xl">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-lg font-semibold text-slate-900">{{ $registration->event->location ?? 'TBA' }}</p>
                                </div>
                            </div>
                        </div>
                    @else
        ...
        <div class="space-y-6">
            ...
            <div class="glass-card">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <a href="{{ route('tickets.pdf', $registration->registration_code) }}" target="_blank" class="w-full inline-flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-slate-700 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 shadow-sm hover:shadow-md">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="glass-card">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-mono text-slate-900">#{{ $registration->id }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-slate-600">Days Since Registration</span>
                        <span class="text-sm font-semibold text-slate-900">{{ $registration->created_at->diffInDays(now()) }} days</span>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card border-red-200">
                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.registrations.destroy', $registration) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this registration? This action cannot be undone.');">
                        @csrf
                        @method('DELETE')
