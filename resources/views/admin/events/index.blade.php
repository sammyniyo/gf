        ...
        <div class="p-4 bg-white rounded-lg border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-2xl font-semibold text-gray-900">{{ $events->total() }}</p>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-2xl font-semibold text-gray-900">
                        {{ $events->filter(function($event) { return \Carbon\Carbon::parse($event->date)->isFuture(); })->count() }}
                    </p>
                </div>
                <div class="p-2 rounded-md bg-gray-100">
                    <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-4 bg-white rounded-lg border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-2xl font-semibold text-gray-900">{{ $events->sum('registrations_count') }}</p>
                </div>
                <div class="p-2 rounded-md bg-gray-100">
                    <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-4 bg-white rounded-lg border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-2xl font-semibold text-gray-900">
                        {{ $events->filter(function($event) { return $event->created_at->isCurrentMonth(); })->count() }}
                    </p>
                </div>
                <div class="p-2 rounded-md bg-gray-100">
                    <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    @if($event->image)
                                        <img src="{{ Storage::url($event->image) }}" alt="{{ $event->name }}" class="w-10 h-10 mr-3 rounded object-cover">
                                    @else
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <a href="{{ route('admin.events.registrations', $event) }}" class="text-sm text-gray-600 hover:text-gray-900">
