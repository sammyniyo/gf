...
<section class="relative min-h-[50vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-emerald-950 via-emerald-900 to-black">
    ...
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/gf-2.jpg')); ?>" alt="Contact Us" class="w-full h-full object-cover opacity-15" />
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <?php $__currentLoopData = [
                            ...
                            <a href="#" class="group w-12 h-12 bg-gradient-to-br <?php echo e($social['color']); ?> rounded-xl flex items-center justify-center hover:scale-110 transition-transform shadow-lg">
                                <img src="<?php echo e(asset('images/' . $social['icon'])); ?>" alt="<?php echo e($social['name']); ?>" class="w-6 h-6 opacity-90 group-hover:opacity-100" />
                            </a>
