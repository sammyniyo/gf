...
<body>
    <div class="email-container">
        ...
        <!-- Content -->
        <div class="content">
            <p class="greeting">Hi <strong><?php echo e($registration->name); ?></strong>,</p>

            <p>Thank you for registering! We're excited to have you join us for this special event.</p>

            <!-- Event Details -->
            <div class="event-details">
                <h2><?php echo e($registration->event->title); ?></h2>

                <div class="detail-row">
                    <span class="detail-label">📅 Date:</span>
                    <span class="detail-value"><?php echo e($registration->event->start_at->format('l, F j, Y')); ?></span>
                </div>

                <div class="detail-row">
                    <span class="detail-label">🕐 Time:</span>
                    <span class="detail-value"><?php echo e($registration->event->start_at->format('g:i A')); ?></span>
                </div>

    <?php if($registration->event->location): ?>
                <div class="detail-row">
                    <span class="detail-label">📍 Location:</span>
                    <span class="detail-value"><?php echo e($registration->event->location); ?></span>
                </div>
    <?php endif; ?>
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e(number_format($registration->total_amount, 0)); ?> RWF</span>
                </div>
    <?php endif; ?>

                <div class="detail-row">
                    <span class="detail-label">🎟️ Ticket Code:</span>
                    <span class="detail-value"><strong><?php echo e($registration->registration_code); ?></strong></span>
                </div>
            </div>
            ...
            <div class="qr-section">
                ...
                <?php if($qrBase64): ?>
                    <img src="<?php echo e($qrBase64); ?>" alt="Entry QR Code">
                <?php else: ?>
                    <div class="qr-fallback">
                        <p>⚠️ QR Code could not be generated</p>
                        <p>Please use your ticket code: <strong><?php echo e($registration->registration_code); ?></strong></p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e($verifyUrl); ?>" class="button">
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px; color: #999; font-size: 12px;">
                Can't attend? <a href="<?php echo e($verifyUrl); ?>">Contact us</a> to let us know.
            </p>
        </div>
    </div>
</body>
