<?php $__env->startSection('title', 'Terms of Use | God\'s Family Choir'); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 md:p-12 prose prose-lg max-w-none">
            ...
            <section class="mb-8">
                ...
                <p class="text-gray-700 leading-relaxed">
                    Your privacy is important to us. Please review our <a href="<?php echo e(route('privacy-policy')); ?>" class="text-emerald-600 hover:text-emerald-700 underline">Privacy Policy</a> to understand how we collect, use, and protect your personal information.
                </p>
            </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/terms-of-use.blade.php ENDPATH**/ ?>