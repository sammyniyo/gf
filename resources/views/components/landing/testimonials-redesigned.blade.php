...
<section class="relative bg-gradient-to-br from-gray-50 to-emerald-50 py-24 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="text-center mt-12">
            ...
            <a href="{{ route('choir.register.form') }}" class="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold rounded-xl hover:shadow-xl hover:shadow-emerald-500/50 transition-all duration-300 transform hover:-translate-y-1">
