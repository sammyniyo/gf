...
<div class="space-y-6">
                ...
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-2">
                            <h3 class="text-lg font-bold text-slate-900"><?php echo e($meeting->title); ?></h3>
                            <?php if($meeting->email_sent): ?>
                        ...
                        <p class="text-sm text-slate-600 mb-3"><?php echo e($meeting->description); ?></p>
                        <div class="flex flex-wrap gap-3 text-sm">
                            <div class="flex items-center gap-2 text-slate-600">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <?php echo e($meeting->meeting_date->format('M d, Y \a\t H:i A')); ?>
                            ...
                            <div class="flex items-center gap-2 text-slate-600">
                                ...
                                <?php echo e($meeting->attendees->count()); ?> attendees
                            </div>
                        </div>
                    </div>
                    <div class="flex gap-2">
                        <?php if(!$meeting->email_sent): ?>
                            <form action="<?php echo e(route('admin.meetings.send-invitations', $meeting)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('admin.meetings.destroy', $meeting)); ?>" method="POST" onsubmit="return confirm('Delete?')">
                            <?php echo csrf_field(); ?>
    ...
    <?php if($meetings->hasPages()): ?>
        <div class="glass-card px-6 py-4"><?php echo e($meetings->links()); ?></div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/admin/meetings/index.blade.php ENDPATH**/ ?>