                    ...
                    <ol class="space-y-6">
                        ...
                        @foreach($milestones as $milestone)
                            <li class="relative border-l-4 border-emerald-300 pl-6 hover:border-emerald-500 transition-colors">
                                <span class="inline-flex rounded-full bg-gradient-to-r from-emerald-100 to-emerald-50 px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-emerald-700 shadow-sm">{{ $milestone['year'] }}</span>
                                <p class="mt-3 text-base font-bold text-gray-900">{{ $milestone['title'] }}</p>
                                <p class="mt-1 text-sm text-gray-600 leading-relaxed">{{ $milestone['detail'] }}</p>
                            </li>
                        @endforeach
                    </ol>
                </div>
