<?php $__env->startSection('title', 'Stories & Testimonies | God\'s Family Choir'); ?>
        ...
        <div class="mx-auto max-w-7xl">
            <div class="text-center space-y-6">
                ...
                <div class="mt-8 max-w-2xl mx-auto">
                    <form action="<?php echo e(route('stories.index')); ?>" method="GET" class="relative">
                        <input type="text" name="search" placeholder="Search stories, testimonies..." value="<?php echo e(request('search')); ?>"
    ...
    <section class="relative z-10 px-6 pb-20 sm:px-8 lg:px-12">
        <div class="mx-auto max-w-7xl">
            ...
            <div class="grid gap-8 md:grid-cols-3">
                <?php $__currentLoopData = $featuredStories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="group relative overflow-hidden rounded-3xl border-2 border-gray-100 bg-white shadow-xl transition-all hover:shadow-2xl hover:-translate-y-2">
                        ...
                        <div class="relative">
                            <a href="<?php echo e(route('story.show', $featured)); ?>" class="block">
                                <?php if($featured->featured_image): ?>
                                    <div class="relative h-64 overflow-hidden">
                                        <img src="<?php echo e(asset('storage/' . $featured->featured_image)); ?>" alt="<?php echo e($featured->title); ?>" class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110">
                                        ...
                                        <div class="absolute bottom-4 left-4 rounded-full border-2 border-white/50 bg-white/95 backdrop-blur-sm px-3 py-1.5 text-xs font-bold text-gray-900">
                                            <?php echo e(ucfirst($featured->category)); ?>
                            ...
                            <div class="p-6 space-y-4">
                                <h3 class="text-2xl font-bold text-gray-900 line-clamp-2 group-hover:text-emerald-600 transition-colors">
                                    <a href="<?php echo e(route('story.show', $featured)); ?>"><?php echo e($featured->title); ?></a>
                                </h3>
                                <p class="text-gray-600 line-clamp-3 leading-relaxed"><?php echo e($featured->excerpt); ?></p>
                                ...
                                <div class="flex items-center gap-4 border-t-2 border-gray-100 pt-4 text-sm text-gray-500">
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span class="font-medium"><?php echo e($featured->reading_time); ?> min</span>
                                    </div>
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <span class="font-medium"><?php echo e(number_format($featured->views_count)); ?></span>
                                    </div>
                                    <?php if($featured->likes_count > 0): ?>
                                        <div class="flex items-center gap-1.5">
                                            <svg class="h-4 w-4 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd" />
                                            </svg>
                                            <span class="font-medium"><?php echo e(number_format($featured->likes_count)); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                ...
                <aside class="lg:col-span-1 space-y-6">
                    ...
                    <div class="overflow-hidden rounded-2xl border-2 border-gray-100 bg-white shadow-lg">
                        ...
                        <div class="p-4 space-y-2">
                            <a href="<?php echo e(route('stories.index')); ?>" class="group flex items-center justify-between rounded-xl px-4 py-3 transition-all <?php echo e(!request('category') ? 'bg-gradient-to-r from-emerald-600 to-emerald-700 text-white shadow-lg' : 'hover:bg-emerald-50'); ?>">
                                <span class="font-semibold">All Stories</span>
                                <svg class="h-4 w-4 <?php echo e(!request('category') ? 'text-white' : 'text-gray-400 group-hover:text-emerald-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                            </a>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('stories.index', ['category' => $key])); ?>" class="group flex items-center justify-between rounded-xl px-4 py-3 transition-all <?php echo e(request('category') == $key ? 'bg-gradient-to-r from-emerald-600 to-emerald-700 text-white shadow-lg' : 'hover:bg-emerald-50'); ?>">
                                    <span class="font-semibold"><?php echo e($label); ?></span>
                                    <svg class="h-4 w-4 <?php echo e(request('category') == $key ? 'text-white' : 'text-gray-400 group-hover:text-emerald-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                    </svg>
                                </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="overflow-hidden rounded-2xl border-2 border-amber-100 bg-gradient-to-br from-amber-50 to-orange-50 shadow-lg">
                            ...
                            <div class="p-4 flex flex-wrap gap-2">
                                <?php $__currentLoopData = $popularTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('stories.index', ['tag' => $tag])); ?>" class="inline-flex items-center gap-1.5 rounded-full border-2 border-amber-200 bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm transition-all hover:border-amber-400 hover:bg-gradient-to-r hover:from-amber-500 hover:to-orange-500 hover:text-white hover:shadow-md hover:scale-105">
                                        <span>#<?php echo e($tag); ?></span>
                                        <span class="text-xs opacity-75">(<?php echo e($count); ?>)</span>
                                    </a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden rounded-2xl border-2 border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 shadow-lg">
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between rounded-xl border-2 border-blue-200 bg-white p-4 shadow-sm">
                                ...
                                <span class="text-3xl font-black text-emerald-600"><?php echo e($stories->total()); ?></span>
                            </div>
                        </div>
                    </div>
                </aside>
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div>
                            <h2 class="text-3xl font-bold text-gray-900">
                                <?php echo e(request('search') ? 'Search Results' : (request('category') ? ucfirst(request('category')) : 'All Stories')); ?>

                            </h2>
                            <p class="mt-1 text-sm text-gray-600"><?php echo e($stories->total()); ?> <?php echo e(Str::plural('story', $stories->total())); ?> found</p>
                        </div>
                        <form action="<?php echo e(route('stories.index')); ?>" method="GET" class="flex items-center gap-2">
                            ...
                            <select name="sort" onchange="this.form.submit()" class="rounded-xl border-2 border-gray-200 px-4 py-2.5 font-semibold text-gray-700 transition-all focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 outline-none bg-white shadow-sm">
                                ...
                                <option value="liked" <?php echo e(request('sort') == 'liked' ? 'selected' : ''); ?>>Most Liked</option>
                            </select>
                        </form>
                    </div>
                        ...
                        <div class="grid gap-8 md:grid-cols-2 mb-12">
                            <?php $__currentLoopData = $stories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <article class="group relative overflow-hidden rounded-2xl border-2 border-gray-100 bg-white shadow-lg transition-all hover:shadow-2xl hover:-translate-y-1">
                                    ...
                                    <div class="relative">
                                        <a href="<?php echo e(route('story.show', $story)); ?>" class="block">
                                            <?php if($story->featured_image): ?>
                                                <div class="relative h-56 overflow-hidden">
                                                    <img src="<?php echo e(asset('storage/' . $story->featured_image)); ?>" alt="<?php echo e($story->title); ?>" class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110">
                                        ...
                                        <div class="p-6 space-y-4">
                                            <h3 class="text-xl font-bold text-gray-900 line-clamp-2 leading-tight group-hover:text-emerald-600 transition-colors">
                                                <a href="<?php echo e(route('story.show', $story)); ?>"><?php echo e($story->title); ?></a>
                                            </h3>
                                            <p class="text-gray-600 line-clamp-2 leading-relaxed"><?php echo e(Str::limit($story->excerpt, 120)); ?></p>

                                            <!-- Tags -->
                                            <?php if($story->tags && count($story->tags) > 0): ?>
                                                <div class="flex flex-wrap gap-2">
                                                    <?php $__currentLoopData = array_slice($story->tags, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="flex items-center justify-between border-t-2 border-gray-100 pt-4 text-sm">
                                                <div class="flex items-center gap-4 text-gray-500">
                                                    <div class="flex items-center gap-1.5">
                                                        ...
                                                        <span class="font-medium"><?php echo e($story->reading_time); ?>m</span>
                                                    </div>
                                                    <div class="flex items-center gap-1.5">
                                                        <svg class="h-4 w-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                        ...
                                                        <span class="font-medium"><?php echo e(number_format($story->views_count)); ?></span>
                                                    </div>
                                                    <?php if($story->likes_count > 0): ?>
                                                        <div class="flex items-center gap-1.5">
                                                            <svg class="h-4 w-4 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                                                                <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd" />
                                                            </svg>
                                                            <span class="font-medium"><?php echo e(number_format($story->likes_count)); ?></span>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                                <span class="font-medium text-gray-400"><?php echo e($story->published_at->format('M d')); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </article>
                    ...
                    <?php else: ?>
                        <div class="rounded-3xl border-2 border-gray-200 bg-white p-16 text-center shadow-lg">
                            ...
                            <a href="<?php echo e(route('stories.index')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-700 px-8 py-4 font-bold text-white shadow-xl transition-all hover:shadow-2xl hover:-translate-y-1">
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mx-auto max-w-5xl">
            <div class="relative overflow-hidden rounded-3xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-600 via-emerald-500 to-blue-600 p-12 text-center shadow-2xl">
                ...
                <div class="relative">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-3 rounded-xl bg-white px-8 py-4 font-bold text-emerald-700 shadow-xl transition-all hover:shadow-2xl hover:bg-gray-50 hover:-translate-y-1">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/stories/index.blade.php ENDPATH**/ ?>