...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 rounded-3xl shadow-xl border-2 border-pink-200 p-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <form action="<?php echo e(route('admin.birthdays.send')); ?>" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg">
                    <h3 class="text-lg font-bold text-pink-600 mb-4 flex items-center gap-2">
                        ...
                        Today's Birthdays (<?php echo e($birthdays_today->count()); ?>)
                    </h3>
                    <?php if($birthdays_today->count() > 0): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $birthdays_today; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="flex items-center justify-between p-3 bg-gradient-to-r from-pink-50 to-purple-50 rounded-lg hover:shadow-md transition-all">
                                    <div class="flex-1">
                                        <p class="font-semibold text-gray-900"><?php echo e($member->first_name); ?> <?php echo e($member->last_name); ?></p>
                                        <p class="text-sm text-gray-600"><?php echo e($member->email); ?></p>
                                        <p class="text-xs text-purple-600 mt-1">Turning <?php echo e($age); ?> years old 🎂</p>
                                    </div>
                                    <a href="mailto:<?php echo e($member->email); ?>" class="inline-flex items-center gap-1 px-3 py-1 bg-pink-500 text-white text-xs font-semibold rounded-full hover:bg-pink-600 transition-all">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg">
                    <h3 class="text-lg font-bold text-indigo-600 mb-4 flex items-center gap-2">
                        <span class="text-2xl">📅</span>
                        This Week (<?php echo e($birthdays_this_week->count()); ?>)
                    </h3>
                    <?php if($birthdays_this_week->count() > 0): ?>
                        <div class="space-y-3 max-h-80 overflow-y-auto">
                            <?php $__currentLoopData = $birthdays_this_week; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $birthdate = \Carbon\Carbon::parse($member->birthdate);
                                ...
                                <div class="flex items-center justify-between p-3 bg-indigo-50 rounded-lg hover:shadow-md transition-all">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <?php else: ?>
                                                <span class="px-2 py-0.5 bg-indigo-500 text-white text-xs font-bold rounded-full"><?php echo e(abs($daysUntil)); ?>d</span>
                                            <?php endif; ?>
                                        </div>
                                        <p class="text-xs text-gray-600"><?php echo e($birthdayThisYear->format('M d')); ?> • Age <?php echo e($age); ?></p>
                                        <p class="text-xs text-gray-500 mt-0.5"><?php echo e(ucfirst($member->member_type ?? 'N/A')); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
            ...
            <!-- This Month Summary -->
            <?php if($birthdays_this_month->count() > 0): ?>
                <div class="mt-6 p-4 bg-white rounded-xl border-2 border-dashed border-purple-200">
                    <p class="text-center text-sm text-gray-700">
                        <span class="font-bold text-purple-600"><?php echo e($birthdays_this_month->count()); ?> birthdays</span> this month
    ...
    (function() {
        ...
        if (calendarEl) {
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                height: 'auto',
                events: '<?php echo e(route('admin.calendar.events')); ?>',
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Documents/gf-1/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>