...
<section class="relative bg-slate-50 py-16 sm:py-20 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="text-2xl md:text-3xl font-bold text-slate-900 mb-3">
                Featured <span class="text-emerald-700">Worship Songs</span>
            </h2>
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="group relative bg-white rounded-3xl border border-emerald-100 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div class="relative h-72 overflow-hidden">
                    <img src="{{ asset('images/gf-2.jpg') }}" alt="Cya Gitondo" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700" />
                ...
                <div class="p-6">
                    ...
                    <div class="bg-emerald-50 rounded-2xl p-4 border border-emerald-100">
                        <audio controls class="w-full audio-player-modern" controlsList="nodownload">
                            <source src="{{ asset('audio/cya_gitondo.mp3') }}" type="audio/mpeg">
            ...
            <!-- Song 2 -->
            <div class="group relative bg-white rounded-3xl border border-emerald-100 overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
                <!-- Album Art -->
                <div class="relative h-72 overflow-hidden">
                    <img src="{{ asset('images/1.jpg') }}" alt="Calvary" class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700" />
                    <div class="absolute inset-0 bg-gradient-to-t from-gray-900/80 via-gray-900/40 to-transparent"></div>
                ...
                <div class="p-6">
                    ...
                    <div class="bg-emerald-50 rounded-2xl p-4 border border-emerald-100">
                        <audio controls class="w-full audio-player-modern" controlsList="nodownload">
                            <source src="{{ asset('audio/calvary.mp3') }}" type="audio/mpeg">
                            Your browser does not support the audio element.
                        </audio>
                    </div>
        ...
        <div class="max-w-5xl mx-auto">
            <div class="group relative bg-white rounded-3xl border border-gray-200 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500">
                <div class="grid md:grid-cols-5 gap-0">
                    <!-- Left: Icon Column -->
                    <div class="md:col-span-2 bg-emerald-50 p-8 flex items-center justify-center relative overflow-hidden">
                        <div class="absolute inset-0">
                        ...
                        <div class="relative z-10">
                            <div class="w-20 h-20 bg-emerald-700 rounded-2xl flex items-center justify-center shadow-lg">
                    ...
                    <div class="md:col-span-3 p-8 flex flex-col justify-center">
                        ...
                        <div>
                            <a href="https://www.youtube.com/@godsfamilychoir5583" target="_blank"
                               class="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-700 text-white text-sm font-semibold rounded-full hover:bg-emerald-600 transition group/btn">
