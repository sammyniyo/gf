    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <a href="/" class="flex items-center space-x-3 group">
                <img src="{{ asset('adventist-en-tm--denim.png') }}" alt="God's Family Choir Logo" class="h-10 w-10 lg:h-12 lg:w-12 object-contain transition-transform duration-300 group-hover:scale-110">
                <div class="lg:hidden">
            ...
            <nav class="hidden md:flex items-center space-x-1" x-data="{
                ...
                <div class="relative">
                    ...
                    <div x-show="aboutMenuOpen"
                        ...
                        <a href="{{ route('committee.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition-colors">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative">
                    ...
                    <div x-show="ministryMenuOpen"
                        ...
                        <a href="{{ route('devotions.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition-colors">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
                            Devotions
                ...
                <!-- Gallery -->
                <a href="{{ route('gallery') }}" class="px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 flex items-center hover:bg-emerald-700/50 hover:text-amber-100 {{ request()->is('gallery*') ? 'bg-emerald-700/50 text-amber-100' : '' }}">
                    <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div x-show="mobileMenuOpen"
        ...
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="{{ route('gallery') }}" @click="mobileMenuOpen = false"
                class="flex items-center px-3 py-3 rounded-md text-base font-medium text-white hover:bg-emerald-700 transition-all duration-200 {{ request()->is('gallery*') ? 'bg-emerald-700 text-amber-100' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                Gallery
