...
<div class="space-y-6">
    ...
    <div class="glass-card p-6">
        <form action="{{ route('admin.contributions.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="space-y-4">
                    ...
                    <div x-data="memberSearch()">
                        ...
                        <div class="relative">
                            <input type="text"
                                   ...
                                   class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-1 focus:ring-emerald-400 focus:border-emerald-400 @error('member_id') border-red-300 @enderror">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <select name="payment_type" id="payment_type" required
                            ...
                            <option value="one_time" {{ old('payment_type') === 'one_time' ? 'selected' : '' }}>One-time</option>
                        </select>
                        @error('payment_type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="flex items-end pb-2">
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="has_paid" value="1" {{ old('has_paid') ? 'checked' : '' }}
                ...
                <div>
                    ...
                    <textarea name="notes" id="notes" rows="3" placeholder="Any additional notes..."
                              class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-1 focus:ring-emerald-400 focus:border-emerald-400 @error('notes') border-red-300 @enderror">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
