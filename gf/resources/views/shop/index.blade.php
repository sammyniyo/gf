    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-8 text-center animate-fade-in animation-delay-600">
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl px-6 py-4 border border-white/20">
                <div class="text-3xl font-bold text-white">{{ \App\Models\Album::active()->count() }}+</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
            ...
            <div class="mt-4 md:mt-0">
                <div class="inline-flex items-center gap-3 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-full px-6 py-3 border-2 border-emerald-200 dark:border-emerald-800">
                    ...
                    <span class="font-bold text-2xl text-emerald-600 dark:text-emerald-400">{{ $albums->total() }}</span>
                    <span class="text-gray-600 dark:text-gray-400 font-medium">{{ Str::plural('Album', $albums->total()) }}</span>
                </div>
            </div>
        </div>
        ...
        @else
            <div class="text-center py-20">
                ...
                <a href="{{ route('home') }}" class="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-lg font-semibold transition-all transform hover:scale-105 shadow-lg">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
