    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .container {
            ...
            padding: 5rem 3rem;
            box-shadow: 0 30px 80px rgba(0,0,0,0.3), 0 10px 40px rgba(245, 158, 11, 0.2);
            position: relative;
            z-index: 10;
        ...
        @keyframes pulse {
            ...
            50% { transform: scale(1.05); box-shadow: 0 25px 80px rgba(245, 158, 11, 0.6); }
        }
        .icon-bg::before {
            content: '';
            position: absolute;
            ...
            right: -10px;
            bottom: -10px;
            background: conic-gradient(from 0deg, #f59e0b, #f97316, #ec4899, #f59e0b);
            border-radius: 50%;
            z-index: -1;
