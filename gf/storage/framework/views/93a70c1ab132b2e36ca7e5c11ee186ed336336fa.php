<?php $__env->startSection('title', 'Create Album'); ?>
...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-3 mb-2">
            <a href="<?php echo e(route('admin.albums.index')); ?>"
    ...
    <!-- Form -->
    <form action="<?php echo e(route('admin.albums.store')); ?>" method="POST" enctype="multipart/form-data"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <textarea id="description"
                      ...
                      rows="4"
                      class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                      placeholder="Describe the album..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number"
                       id="track_count"
                       name="track_count"
                       value="<?php echo e(old('track_count')); ?>"
                       min="0"
                       class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                       placeholder="12">
                <?php $__errorArgs = ['track_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="url"
                           id="spotify_url"
                           name="spotify_url"
                           value="<?php echo e(old('spotify_url')); ?>"
                           class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="url"
                           ...
                           value="<?php echo e(old('apple_music_url')); ?>"
                           class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="url"
                           id="youtube_url"
                           name="youtube_url"
                           value="<?php echo e(old('youtube_url')); ?>"
                           class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/admin/albums/create.blade.php ENDPATH**/ ?>