<?php $__env->startSection('title', 'Contact Us | God\'s Family Choir'); ?>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="rounded-2xl border-2 border-gray-100 bg-white p-6 shadow-lg">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <a href="#" target="_blank" class="flex flex-col items-center gap-2 rounded-xl border-2 border-blue-100 bg-blue-50 p-4 transition-all hover:border-blue-300 hover:shadow-md hover:-translate-y-1">
                            ...
                            <a href="#" target="_blank" class="flex flex-col items-center gap-2 rounded-xl border-2 border-pink-100 bg-pink-50 p-4 transition-all hover:border-pink-300 hover:shadow-md hover:-translate-y-1">
                            ...
                            <a href="#" target="_blank" class="flex flex-col items-center gap-2 rounded-xl border-2 border-red-100 bg-red-50 p-4 transition-all hover:border-red-300 hover:shadow-md hover:-translate-y-1">
                        ...
                        <?php if(session('success')): ?>
                            <div class="mx-8 mt-6 rounded-xl border-2 border-emerald-200 bg-emerald-50 p-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <p class="text-sm font-semibold text-emerald-900"><?php echo e(session('success')); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>

                        <!-- Form -->
                        <form method="POST" action="<?php echo e(route('contact.submit')); ?>" class="p-8 space-y-6">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="grid sm:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" required
                                        class="w-full rounded-xl border-2 border-gray-200 px-4 py-3 text-gray-900 transition-all focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 outline-none <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" required
                                        class="w-full rounded-xl border-2 border-gray-200 px-4 py-3 text-gray-900 transition-all focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 outline-none <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
                            ...
                            <div class="grid sm:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>"
                                        class="w-full rounded-xl border-2 border-gray-200 px-4 py-3 text-gray-900 transition-all focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 outline-none <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="subject"
                                        class="w-full rounded-xl border-2 border-gray-200 px-4 py-3 text-gray-900 transition-all focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 outline-none <?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="Event Booking" <?php echo e(old('subject') === 'Event Booking' ? 'selected' : ''); ?>>Event Booking</option>
                                        <option value="Join Choir" <?php echo e(old('subject') === 'Join Choir' ? 'selected' : ''); ?>>Join the Choir</option>
                                        <option value="Prayer Request" <?php echo e(old('subject') === 'Prayer Request' ? 'selected' : ''); ?>>Prayer Request</option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="message" rows="6" required
                                    class="w-full rounded-xl border-2 border-gray-200 px-4 py-3 text-gray-900 transition-all focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 outline-none resize-none <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Tell us how we can help you..."><?php echo e(old('message')); ?></textarea>
            ...
            <div class="mx-auto max-w-4xl space-y-4" x-data="{ openFaq: null }">
                ...
                <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="overflow-hidden rounded-2xl border-2 border-gray-100 bg-white shadow-lg transition-all hover:shadow-xl"
                         x-data="{ faqIndex: <?php echo e($index); ?> }">
                        <button @click="openFaq = openFaq === faqIndex ? null : faqIndex"
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <h3 class="text-lg font-bold text-gray-900"><?php echo e($faq['question']); ?></h3>
                            </div>
                        ...
                        <div x-show="openFaq === faqIndex"
                            ...
                            <p class="text-gray-700 leading-relaxed pl-14"><?php echo e($faq['answer']); ?></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/contact.blade.php ENDPATH**/ ?>