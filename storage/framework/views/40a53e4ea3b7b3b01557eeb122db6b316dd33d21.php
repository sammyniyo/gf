        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a href="<?php echo e(route('home')); ?>" class="text-white/80 hover:text-cyan-300 transition-colors font-medium">Home</a>
                    <a href="<?php echo e(route('about')); ?>" class="text-white/80 hover:text-cyan-300 transition-colors font-medium">About</a>
                    <a href="<?php echo e(route('events.index')); ?>" class="text-white/80 hover:text-cyan-300 transition-colors font-medium">Events</a>
                    <a href="<?php echo e(route('contact')); ?>" class="text-white/80 hover:text-cyan-300 transition-colors font-medium">Contact</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="relative min-h-screen flex items-center justify-center px-6">
        ...
        <div class="relative z-10 text-center max-w-6xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
                <a href="<?php echo e(route('home')); ?>" class="group relative inline-flex items-center gap-4 px-10 py-5 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-bold rounded-2xl hover:shadow-2xl hover:shadow-cyan-500/50 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
                ...
                <a href="<?php echo e(route('events.index')); ?>" class="group inline-flex items-center gap-4 px-10 py-5 bg-white/10 backdrop-blur-sm text-white font-bold rounded-2xl border-2 border-cyan-400/30 hover:bg-white/20 hover:border-cyan-400/50 transition-all duration-500 transform hover:-translate-y-2">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                <a href="<?php echo e(route('about')); ?>" class="group bg-white/5 backdrop-blur-xl border border-cyan-400/10 rounded-2xl p-6 hover:bg-white/10 hover:border-cyan-400/30 transition-all duration-500 transform hover:-translate-y-2">
                ...
                <a href="<?php echo e(route('story')); ?>" class="group bg-white/5 backdrop-blur-xl border border-blue-400/10 rounded-2xl p-6 hover:bg-white/10 hover:border-blue-400/30 transition-all duration-500 transform hover:-translate-y-2">
                    <div class="text-center">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="group bg-white/5 backdrop-blur-xl border border-cyan-400/10 rounded-2xl p-6 hover:bg-white/10 hover:border-cyan-400/30 transition-all duration-500 transform hover:-translate-y-2">
                    <div class="text-center">
            ...
            <div class="bg-white/5 backdrop-blur-xl border border-cyan-400/20 rounded-3xl p-8 max-w-4xl mx-auto mb-16">
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="<?php echo e(route('choir.register.form')); ?>" class="flex items-center gap-3 text-gray-300 hover:text-cyan-300 transition-colors group">
                                <i class="fas fa-music text-cyan-400 group-hover:scale-110 transition-transform"></i>
                                <span>Join the Choir</span>
                            </a></li>
                            <li><a href="<?php echo e(route('events.index')); ?>" class="flex items-center gap-3 text-gray-300 hover:text-cyan-300 transition-colors group">
                                <i class="fas fa-calendar text-cyan-400 group-hover:scale-110 transition-transform"></i>
                                <span>Upcoming Events</span>
                            </a></li>
                            <li><a href="<?php echo e(route('privacy-policy')); ?>" class="flex items-center gap-3 text-gray-300 hover:text-cyan-300 transition-colors group">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="<?php echo e(route('about')); ?>" class="flex items-center gap-3 text-gray-300 hover:text-blue-300 transition-colors group">
                                <i class="fas fa-info-circle text-blue-400 group-hover:scale-110 transition-transform"></i>
                                <span>About Our Ministry</span>
                            </a></li>
                            <li><a href="<?php echo e(route('story')); ?>" class="flex items-center gap-3 text-gray-300 hover:text-blue-300 transition-colors group">
                                <i class="fas fa-history text-blue-400 group-hover:scale-110 transition-transform"></i>
                                <span>Our History</span>
                            </a></li>
                            <li><a href="<?php echo e(route('contact')); ?>" class="flex items-center gap-3 text-gray-300 hover:text-blue-300 transition-colors group">
    ...
    <footer class="relative z-10 bg-black/30 backdrop-blur-xl border-t border-white/10 py-8">
        <div class="max-w-7xl mx-auto px-6 text-center">
            <p class="text-gray-400 mb-4">
                © <?php echo e(date('Y')); ?> God's Family Choir - ASA UR Nyarugenge SDA. All rights reserved.
            </p>
            <div class="flex items-center justify-center gap-6">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="text-gray-400 hover:text-white transition-colors">Contact</a>
                <a href="<?php echo e(route('privacy-policy')); ?>" class="text-gray-400 hover:text-white transition-colors">Privacy</a>
            </div>
        </div>
    </footer>
</body>
</html>
<?php /**PATH C:\Users\samsh\Documents\gf\resources\views/errors/404.blade.php ENDPATH**/ ?>