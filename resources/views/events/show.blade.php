...
<section class="relative min-h-[70vh] flex items-end overflow-hidden bg-emerald-950">
    <!-- Event Cover Image -->
    <div class="absolute inset-0">
        ...
        <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-emerald-900/40 via-transparent to-transparent"></div>
    </div>

    <!-- Enhanced Mesh Gradient Animation -->
    <div class="absolute inset-0 opacity-40">
        <div class="absolute top-0 left-0 w-[500px] h-[500px] bg-emerald-700/30 rounded-full blur-[140px]"></div>
        <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-amber-500/20 rounded-full blur-[140px]"></div>
    </div>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="flex flex-wrap items-center gap-3 animate-fade-in-up animation-delay-200">
                    <span class="px-4 py-1.5 bg-white/95 rounded-full text-xs font-semibold text-slate-800 uppercase tracking-wide">
                            {{ $event->type }}
                        </span>
                    ...
                    <span class="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold
                            {{ $isPast ? 'bg-slate-700 text-white' :
                               ($isFull ? 'bg-slate-600 text-white' :
                ...
                <!-- Title -->
                <h1 class="text-3xl md:text-5xl font-bold text-white leading-tight animate-fade-in-up animation-delay-400">
                    {{ $event->title }}
                </h1>
            ...
            <div class="lg:col-span-1 animate-fade-in-up animation-delay-800">
                <div class="relative">
                    <div class="absolute inset-0 bg-emerald-500/20 rounded-3xl blur-2xl"></div>
                    <div class="relative bg-white/10 backdrop-blur-2xl border-2 border-white/20 rounded-3xl p-8 space-y-6 shadow-2xl">
                        <!-- Date & Time -->
                        <div class="flex items-start gap-4">
                            <div class="flex items-center justify-center w-16 h-16 bg-emerald-700 rounded-2xl">
                                <div class="text-center">
                                    <div class="text-white text-xs font-semibold leading-none uppercase">{{ $event->start_at->format('M') }}</div>
                                    <div class="text-white text-2xl font-bold leading-none mt-1">{{ $event->start_at->format('j') }}</div>
                                </div>
                            </div>
                            <div>
                                <p class="text-white font-bold text-lg">{{ $event->start_at->format('l') }}</p>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="mt-2 bg-gray-700/50 rounded-full h-2.5 overflow-hidden">
                                        <div class="h-full bg-emerald-400 transition-all duration-500 rounded-full"
                        ...
                        @if($isOpen)
                            <a href="{{ route('events.register', $event) }}"
                               class="w-full inline-flex items-center justify-center gap-3 px-8 py-3 bg-emerald-700 hover:bg-emerald-600 text-white font-semibold rounded-full transition">
                        ...
                        @else
                            <div class="w-full inline-flex items-center justify-center gap-3 px-8 py-3 bg-slate-600 text-white font-semibold rounded-full cursor-not-allowed">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2 space-y-12">
                        ...
                        <div class="relative">
                            ...
                            <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-6 mb-4">
                                ...
                                <div class="bg-white/20 rounded-full h-4 overflow-hidden">
                                    <div class="h-full bg-white transition-all duration-500 rounded-full"
                                        style="width: {{ $event->capacity > 0 ? ($event->registrations_count / $event->capacity * 100) : 0 }}%">
                                    </div>
                                </div>
                            </div>
                ...
                <!-- What to Expect -->
                <div class="bg-emerald-50 rounded-3xl shadow-xl p-10 border border-emerald-100">
                    <div class="flex items-center gap-3 mb-6">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-4">
                            <div class="flex-shrink-0 w-8 h-8 bg-emerald-200 rounded-lg flex items-center justify-center">
                                <span class="text-emerald-800 font-bold">1</span>
                            </div>
                            <div>
                        ...
                        <li class="flex items-start gap-4">
                            <div class="flex-shrink-0 w-8 h-8 bg-emerald-200 rounded-lg flex items-center justify-center">
                                <span class="text-emerald-800 font-bold">2</span>
                            </div>
                            <div>
                        ...
                        <li class="flex items-start gap-4">
                            <div class="flex-shrink-0 w-8 h-8 bg-emerald-200 rounded-lg flex items-center justify-center">
                                <span class="text-emerald-800 font-bold">3</span>
                            </div>
                            <div>
            ...
            <div class="lg:col-span-1 space-y-8">
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100 sticky top-24">
                    ...
                    <div class="space-y-3">
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('events.show', $event)) }}" target="_blank"
                           class="flex items-center gap-3 w-full px-6 py-3 bg-white border border-slate-200 text-slate-800 font-semibold rounded-full hover:border-emerald-300 transition">
                        ...
                        <button onclick="copyLink()"
                           class="flex items-center gap-3 w-full px-6 py-3 bg-emerald-700 text-white font-semibold rounded-full hover:bg-emerald-600 transition">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Need Help -->
                <div class="bg-emerald-50 rounded-3xl shadow-lg p-8 border border-emerald-100">
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Need Help?</h3>
                    <p class="text-gray-700 mb-6 leading-relaxed">
                        Have questions about this event? We're here to help!
                    </p>
                    <a href="{{ route('contact') }}" class="inline-flex items-center gap-2 px-6 py-2.5 bg-emerald-700 hover:bg-emerald-600 text-white font-semibold rounded-full transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<section class="py-16 bg-gradient-to-br from-emerald-950 via-teal-950 to-black relative overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <a href="{{ route('events.index') }}" class="inline-flex items-center justify-center gap-2 px-8 py-3 bg-white text-emerald-800 font-semibold rounded-full hover:bg-emerald-50 transition">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
