<?php $__env->startSection('title', 'Leadership | God\'s Family Choir'); ?>
                        ...
                        <div>
                            ...
                            <div class="mb-12 text-center">
                                <div class="inline-flex items-center gap-3 rounded-full border border-indigo-200 bg-white/80 px-5 py-2 shadow-sm backdrop-blur">
                                    ...
                                    <span class="text-sm font-semibold text-slate-900"><?php echo e($department); ?></span>
                                                ...
                                                <?php if($member->email): ?>
                                                    <a href="mailto:<?php echo e($member->email); ?>"
                                                       class="group/email flex items-center gap-2 text-sm text-slate-600 transition-colors hover:text-indigo-600">
                                                        ...
                                                        <span class="truncate text-xs"><?php echo e($member->email); ?></span>
                                                    </a>
                                                <?php endif; ?>
                                                ...
                                                <?php if($member->phone): ?>
                                                    <a href="tel:<?php echo e($member->phone); ?>"
                                                       class="group/phone flex items-center gap-2 text-sm text-slate-600 transition-colors hover:text-indigo-600">
                                                        ...
                                                        <span class="text-xs"><?php echo e($member->phone); ?></span>
                                                    </a>
                                                <?php endif; ?>
                                            </div>
