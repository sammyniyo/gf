...
<head>
    ...
    <title>{{ $settings->coming_soon_title ?? 'Coming Soon' }} - {{ config('app.name') }}</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>{{ $settings->coming_soon_title ?? 'Coming Soon!' }}</h1>
        <p class="subtitle">{{ $settings->coming_soon_message ?? 'We are working hard to bring you something amazing. Stay tuned for an incredible experience!' }}</p>
        ...
        <div class="message-box">
            <p>Questions? Contact us at <a href="mailto:{{ $settings->contact_email }}" class="font-semibold text-emerald-600 hover:text-emerald-700">{{ $settings->contact_email }}</a></p>
        </div>
        @endif
    </div>
    <script>
