        ...
        <div class="w-full max-w-6xl mx-auto flex flex-col lg:flex-row lg:items-stretch lg:gap-10">
            ...
            <div class="hidden lg:flex w-full max-w-xl flex-col justify-between overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-700 via-slate-900 to-slate-950 p-10 text-white shadow-2xl animate-slide-in">
                ...
                <div class="flex items-center justify-between text-xs text-white-visible opacity-70">
                    <span>Secured access · <?php echo e(now()->format('M d, Y')); ?></span>
                    <span>@GF</span>
                </div>
            </div>
            ...
            <div class="flex w-full flex-1 items-center justify-center">
                <div class="w-full max-w-lg rounded-3xl form-container p-8 shadow-xl animate-slide-in delay-200">
                    <div class="mb-8 flex items-center justify-between animate-slide-in delay-300">
                        ...
                        <a href="<?php echo e(route('home')); ?>" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-gray-300 bg-white text-gray-500 transition hover:text-indigo-500" aria-label="Back to website">
                    ...
                    <form id="admin-login-form" method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="animate-slide-in delay-400">
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <?php if(Route::has('password.request')): ?>
                                    <a class="font-semibold text-indigo-visible hover:text-indigo-600" href="<?php echo e(route('password.request')); ?>">
                                        Forgot password?
                                    </a>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/auth/login.blade.php ENDPATH**/ ?>