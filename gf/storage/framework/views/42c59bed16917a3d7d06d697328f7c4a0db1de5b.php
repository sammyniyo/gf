<?php $__env->startSection('page-title', 'Utility Folder - Resources'); ?>
...
<div class="space-y-6">
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="glass-card p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-slate-600"><?php echo e($label); ?></p>
                        <p class="mt-2 text-3xl font-bold text-slate-900"><?php echo e($count); ?></p>
                    </div>
                    <div class="w-12 h-12 rounded-xl bg-gradient-to-br <?php echo e($iconColors[$key] ?? 'from-gray-500 to-gray-600'); ?> flex items-center justify-center shadow-lg">
    ...
    <div class="glass-card p-5">
        <form method="GET" action="<?php echo e(route('admin.resources.index')); ?>" class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="<?php echo e(route('admin.resources.index')); ?>" class="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-600 transition hover:border-slate-300">
                    Reset
                </a>
            </div>
        </form>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <?php if($resource->isImage()): ?>
                                            <img src="<?php echo e($resource->file_url); ?>" alt="<?php echo e($resource->title); ?>" class="w-12 h-12 rounded-lg object-cover shadow-sm">
                                        <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                        <div>
                                            <p class="text-sm font-semibold text-slate-900"><?php echo e($resource->title); ?></p>
                                            <?php if($resource->description): ?>
                                                <p class="text-xs text-slate-500 line-clamp-1"><?php echo e($resource->description); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-slate-100 text-slate-700">
                                        <?php echo e($resource->category_label); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <p class="text-xs text-slate-600"><?php echo e(strtoupper($resource->file_type)); ?></p>
                                    <p class="text-xs text-slate-500"><?php echo e($resource->formatted_file_size); ?></p>
                                </td>
                                <td class="px-6 py-4">
                                    <p class="text-sm font-semibold text-slate-900"><?php echo e($resource->downloads); ?></p>
                                </td>
                                <td class="px-6 py-4">
                                    <button onclick="toggleStatus(<?php echo e($resource->id); ?>)"
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold transition-colors
                                            <?php echo e($resource->is_active ? 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200' : 'bg-red-100 text-red-700 hover:bg-red-200'); ?>">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="<?php echo e(route('admin.resources.edit', $resource)); ?>"
                                        ...
                                        <form action="<?php echo e(route('admin.resources.destroy', $resource)); ?>" method="POST" class="inline-block">
                                            <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
        <div class="glass-card p-12 text-center">
            ...
            <a href="<?php echo e(route('admin.resources.create')); ?>" class="inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-6 py-2.5 text-sm font-semibold text-white hover:bg-emerald-500 transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                </svg>
                Upload Resource
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/admin/resources/index.blade.php ENDPATH**/ ?>