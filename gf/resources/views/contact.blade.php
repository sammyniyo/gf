        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-4">
                    ...
                    <!-- WhatsApp -->
                    <a href="https://wa.me/250783871782" target="_blank" class="group block p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-green-300">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-green-600 font-medium">+250 783 871 782</p>
                                <p class="text-sm text-gray-500 mt-1">Chat with us instantly</p>
                            </div>
                        </div>
                    </a>
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <!-- Facebook -->
                        <a href="#" target="_blank" class="w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg">
                        ...
                        <!-- Instagram -->
                        <a href="#" target="_blank" class="w-12 h-12 bg-gradient-to-br from-pink-500 to-purple-600 rounded-xl flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- YouTube -->
                        <a href="#" target="_blank" class="w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- SoundCloud -->
                        <a href="#" target="_blank" class="w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1s-1 .45-1 1v3h-1c-.9 0-1.64.58-1.9 1.39-.26.81.07 1.69.8 2.15.73.46 1.67.46 2.4 0 .73-.46 1.06-1.34.8-2.15z"/>
                            </svg>
                        </a>

                        <!-- Twitter/X -->
                        <a href="#" target="_blank" class="w-12 h-12 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl flex items-center justify-center text-white hover:scale-110 transition-transform shadow-lg">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div x-data="{ formSubmitted: false }">
                <div class="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
                    ...
                    <!-- Success Message -->
                    @if(session('success'))
                        <div class="mx-8 mt-6 p-4 bg-emerald-50 border border-emerald-200 rounded-xl">
                    ...
                    <form method="POST" action="{{ route('contact.submit') }}" class="p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="relative">
                                <input type="text" name="name" value="{{ old('name') }}" required
                                    class="peer w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all outline-none @error('name') border-red-300 @enderror"
                                    placeholder=" ">
                            ...
                            <div class="relative">
                                <input type="email" name="email" value="{{ old('email') }}" required
                                    class="peer w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all outline-none @error('email') border-red-300 @enderror"
                                    placeholder=" ">
                                <label class="absolute left-4 -top-3 bg-white px-2 text-sm font-semibold text-emerald-600">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="relative">
                                <input type="tel" name="phone" value="{{ old('phone') }}"
                                    class="peer w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all outline-none @error('phone') border-red-300 @enderror"
                                    placeholder=" ">
                                <label class="absolute left-4 -top-3 bg-white px-2 text-sm font-semibold text-emerald-600">
                                    Phone Number
                                </label>
                            ...
                            <div class="relative">
                                <select name="subject" required
                                    class="peer w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all outline-none @error('subject') border-red-300 @enderror">
                                    <option value="">Choose a subject</option>
                                    <option value="General Inquiry" {{ old('subject') === 'General Inquiry' ? 'selected' : '' }}>General Inquiry</option>
                                    <option value="Prayer Request" {{ old('subject') === 'Prayer Request' ? 'selected' : '' }}>Prayer Request</option>
                                    <option value="Booking" {{ old('subject') === 'Booking' ? 'selected' : '' }}>Event Booking / Invitation</option>
                                    <option value="Join Choir" {{ old('subject') === 'Join Choir' ? 'selected' : '' }}>Joining the Choir</option>
                        ...
                        <div class="relative">
                            <textarea name="message" rows="6" required
                                class="peer w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all outline-none resize-none @error('message') border-red-300 @enderror"
                        ...
                        <button type="submit"
                            class="w-full py-4 px-6 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold text-lg rounded-xl hover:shadow-xl hover:shadow-emerald-500/50 transition-all duration-300 transform hover:-translate-y-0.5 flex items-center justify-center gap-3">
                        ...
                        <!-- Trust Indicators -->
                        <div class="flex items-center justify-center gap-8 pt-4 border-t border-gray-100">
                ...
                @php
                    $faqs = [
                        [
                            ...
                            'answer' => 'Click the "Join Our Choir" button in the navigation menu to fill out our registration form. Our team will review your application and get back to you within 2-3 business days.'
                        ],
                        [
                            'question' => 'Do I need musical experience to join?',
                            'answer' => 'Not at all! We welcome members of all skill levels. Whether you\'re a beginner or have years of experience, there\'s a place for you in our choir family.'
                        ],
                        [
                            'question' => 'How can I book the choir for an event?',
                            'answer' => 'Send us a message through the contact form above with the subject "Event Booking" and include your event details (date, location, type of event). We\'ll get back to you with availability and pricing.'
                        ],
                        [
                            'question' => 'When and where do you practice?',
                            'answer' => 'We hold regular rehearsals at ASA UR Nyarugenge SDA in Kigali. Specific times vary, so please join our WhatsApp group or contact us for the current schedule.'
                        ],
                        [
                            'question' => 'How can I support the choir?',
                            'answer' => 'You can support us through prayers, financial contributions, attending our events, or sharing our music with others. Contact us to learn more about partnership opportunities.'
                        ],
                        [
                            'question' => 'Do you offer music lessons?',
                            'answer' => 'Yes! We occasionally offer workshops and training sessions for our members. Contact us to learn about upcoming opportunities.'
                        ],
                    ];
                @endphp
                ...
                @foreach($faqs as $index => $faq)
                    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden"
                        ...
                        <button @click="openFaq = openFaq === faqIndex ? null : faqIndex"
                            ...
                            <svg class="w-5 h-5 text-emerald-600 transform transition-transform"
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Find Us <span class="text-emerald-600">Here</span>
            </h2>
            <p class="text-lg text-gray-600">ASA UR Nyarugenge SDA, Kigali, Rwanda</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
            <div class="aspect-video bg-gray-100 flex items-center justify-center">
                ...
                <div class="text-center p-8">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">ASA UR Nyarugenge SDA</h3>
                    <p class="text-gray-600 mb-4">Kigali, Rwanda</p>
                    <a href="https://maps.google.com/?q=ASA+UR+Nyarugenge+SDA+Kigali" target="_blank"
                       class="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 text-white font-semibold rounded-xl hover:bg-emerald-700 transition-colors shadow-lg hover:shadow-xl">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
