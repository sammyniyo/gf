        ...
        <div class="glass-card p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-900">{{ number_format($totalAmount, 0) }} RWF</p>
                </div>
    ...
    <div class="glass-card p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-emerald-600">{{ number_format($paidAmount, 0) }} RWF</p>
                </div>
        ...
        <div class="glass-card p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-amber-600">{{ number_format($pendingAmount, 0) }} RWF</p>
                </div>
