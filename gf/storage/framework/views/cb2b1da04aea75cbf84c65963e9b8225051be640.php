<?php $__env->startSection('title', $event->title . ' | God\'s Family Choir'); ?>
...
<section class="relative min-h-[85vh] flex items-end overflow-hidden bg-gradient-to-br from-slate-950 via-purple-950 to-black">
    ...
    <div class="absolute inset-0">
        <?php if($event->cover_image): ?>
            <img src="<?php echo e(Storage::url($event->cover_image)); ?>" alt="<?php echo e($event->title); ?>" class="w-full h-full object-cover opacity-30" />
        <?php else: ?>
            <img src="<?php echo e(asset('images/gf-2.jpg')); ?>" alt="<?php echo e($event->title); ?>" class="w-full h-full object-cover opacity-20" />
        <?php endif; ?>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 py-16 w-full">
        ...
        <nav class="mb-8 animate-fade-in-up">
            <ol class="flex items-center gap-3 text-sm">
                <li><a href="<?php echo e(route('home')); ?>" class="text-gray-400 hover:text-white transition-colors font-medium">Home</a></li>
                <li><span class="text-gray-600">›</span></li>
                <li><a href="<?php echo e(route('events.index')); ?>" class="text-gray-400 hover:text-white transition-colors font-medium">Events</a></li>
                <li><span class="text-gray-600">›</span></li>
                <li><span class="text-white font-bold"><?php echo e(Str::limit($event->title, 40)); ?></span></li>
            </ol>
        </nav>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="flex flex-wrap items-center gap-3 animate-fade-in-up animation-delay-200">
                    ...
                    <div class="relative">
                        <div class="absolute inset-0 <?php echo e($isOpen ? 'bg-emerald-500/50' : 'bg-gray-500/50'); ?> rounded-2xl blur-xl"></div>
                        <span class="relative flex items-center gap-2 px-5 py-2.5 backdrop-blur-xl rounded-2xl text-sm font-black border-2 shadow-2xl
                            ...
                            <span class="text-lg"><?php echo e($isPast ? '📅' : ($isFull ? '🔒' : '✅')); ?></span>
                            <span><?php echo e($isPast ? 'Past Event' : ($isFull ? 'Event Full' : 'Registration Open')); ?></span>
                        </span>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1 animate-fade-in-up animation-delay-800">
                <div class="relative">
                    ...
                    <div class="relative bg-white/10 backdrop-blur-2xl border-2 border-white/20 rounded-3xl p-8 space-y-6 shadow-2xl">
                        ...
                        <div class="flex items-start gap-4">
                            <div class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl shadow-xl">
                                <div class="text-center">
                                    <div class="text-white text-xs font-bold leading-none uppercase"><?php echo e($event->start_at->format('M')); ?></div>
                                    <div class="text-white text-2xl font-black leading-none mt-1"><?php echo e($event->start_at->format('j')); ?></div>
                                </div>
                            </div>
                            <div>
                                <p class="text-white font-black text-lg"><?php echo e($event->start_at->format('l')); ?></p>
                                <p class="text-emerald-300 font-bold"><?php echo e($event->start_at->format('F j, Y')); ?></p>
                                <p class="text-gray-400 text-sm mt-1"><?php echo e($event->start_at->format('g:i A')); ?>

                                    <?php if($event->end_at): ?>
                                        - <?php echo e($event->end_at->format('g:i A')); ?>
                        ...
                        <?php if($event->location): ?>
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-white font-bold text-lg"><?php echo e($event->location); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($event->capacity): ?>
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-white font-black text-lg"><?php echo e($event->registrations_count); ?> / <?php echo e($event->capacity); ?></p>
                                    <div class="mt-2 bg-gray-700/50 rounded-full h-2.5 overflow-hidden">
                                        <div class="h-full bg-gradient-to-r from-purple-500 to-pink-500 transition-all duration-500 rounded-full"
                                            style="width: <?php echo e($event->capacity > 0 ? ($event->registrations_count / $event->capacity * 100) : 0); ?>%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- CTA Button -->
                        <?php if($isOpen): ?>
                            <a href="<?php echo e(route('events.register', $event)); ?>"
                        ...
                        <?php else: ?>
                            <div class="w-full inline-flex items-center justify-center gap-3 px-8 py-4 bg-gray-700 text-white font-black text-lg rounded-xl shadow-xl cursor-not-allowed">
                                ...
                                <?php echo e($isPast ? 'Event Has Passed' : 'Event is Full'); ?>
        ...
        <div class="grid lg:grid-cols-3 gap-12">
                        ...
                        <div class="relative">
                            ...
                            <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-6 mb-4">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <span class="text-2xl font-black"><?php echo e($event->registrations_count); ?> / <?php echo e($event->capacity); ?></span>
                                </div>
                            ...
                            <p class="text-emerald-100 text-lg leading-relaxed">
                                <?php if($event->registrations_count >= $event->capacity): ?>
                                    🔒 This event is currently full. Join the waiting list to be notified if spots become available.
                                <?php else: ?>
                                    ✅ <?php echo e($event->capacity - $event->registrations_count); ?> <?php echo e(Str::plural('spot', $event->capacity - $event->registrations_count)); ?> remaining! Register now to secure your place.
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-1 space-y-8">
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100 sticky top-24">
                    ...
                    <div class="space-y-3">
                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(route('events.show', $event))); ?>" target="_blank"
                        ...
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(route('events.show', $event))); ?>&text=<?php echo e(urlencode($event->title)); ?>" target="_blank"
                        ...
                        <a href="https://wa.me/?text=<?php echo e(urlencode($event->title . ' - ' . route('events.show', $event))); ?>" target="_blank"
                ...
                <div class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl shadow-xl p-8 border border-amber-100">
                    ...
                    <a href="<?php echo e(route('contact.submit')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold rounded-xl shadow-lg hover:scale-105 transition-all">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<section class="py-16 bg-gradient-to-br from-emerald-950 via-teal-950 to-black relative overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <a href="<?php echo e(route('events.index')); ?>" class="inline-flex items-center justify-center gap-3 px-10 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-emerald-950 font-black text-lg rounded-xl shadow-2xl shadow-amber-500/50 hover:scale-105 transition-all">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\samsh\Documents\gf\gf\resources\views/events/show.blade.php ENDPATH**/ ?>